...
//        that has been addressed only in G++ v13
...
#define __CLOVE_SWITCH_CASE(Y) else if (expr == (size_t*)(size_t)Y)
#define __CLOVE_SWITCH_DEFAULT() else
...
// mainly math header operations re-implemented to avoid explicit linking to
// math library on unix os (with option -lm).
__CLOVE_EXTERN_C unsigned int __clove_math_powi(unsigned int base,
                                                unsigned int exp);
...
__CLOVE_EXTERN_C char* __clove_path_concat(const char* path1, const char* path2,
                                           const char separator);
__CLOVE_EXTERN_C const char* __clove_path_relative(const char* abs_path,
...
__CLOVE_EXTERN_C bool __clove_memory_memcpy(void* dest, size_t dest_size,
                                            const void* src, size_t src_size);
__CLOVE_EXTERN_C bool __clove_memory_memset(void* dest, size_t size,
                                            unsigned char value);
__CLOVE_EXTERN_C void __clove_memory_free(void* source);

#define __CLOVE_MEMORY_MALLOC_TYPE_N(TYPE, COUNT)                              \
    (TYPE*)__clove_memory_malloc(sizeof(TYPE) * COUNT)
#define __CLOVE_MEMORY_MALLOC_TYPE(TYPE) __CLOVE_MEMORY_MALLOC_TYPE_N(TYPE, 1)

#define __CLOVE_MEMORY_CALLOC_TYPE_N(TYPE, COUNT)                              \
    (TYPE*)__clove_memory_calloc(sizeof(TYPE) * COUNT)
...
__CLOVE_EXTERN_C void __clove_file_vprintf(FILE* file, const char* format,
                                           va_list args);
...
__CLOVE_EXTERN_C bool __clove_string_equal_any(const char* str1, size_t count,
                                               ...);
__CLOVE_EXTERN_C bool __clove_string_startswith(const char* str1,
                                                const char* prefix);
__CLOVE_EXTERN_C bool __clove_string_endswith(const char* str1,
                                              const char* suffix);
__CLOVE_EXTERN_C bool __clove_string_strncmp(const char* str1, const char* str2,
                                             size_t count);
__CLOVE_EXTERN_C bool __clove_string_strcpy(char* dest, size_t dest_size,
                                            const char* source);
__CLOVE_EXTERN_C bool __clove_string_strncpy(char* dest, size_t dest_size,
                                             const char* source, size_t count);
__CLOVE_EXTERN_C bool __clove_string_strcat(char* dest, size_t dest_size,
                                            const char* source);
__CLOVE_EXTERN_C bool __clove_string_strncat(char* dest, size_t dest_size,
                                             const char* source, size_t count);
__CLOVE_EXTERN_C char* __clove_string_strdup(const char* str);
__CLOVE_EXTERN_C void __clove_string_sprintf(char* dest, size_t dest_size,
                                             const char* format, ...);
__CLOVE_EXTERN_C void __clove_string_vsprintf(char* dest, size_t dest_size,
                                              const char* format, va_list args);
__CLOVE_EXTERN_C size_t __clove_string_length(const char* str);
__CLOVE_EXTERN_C const char* __clove_string_strstr(const char* str1,
                                                   const char* str2);
__CLOVE_EXTERN_C bool __clove_string_contains(const char* string,
...
__CLOVE_EXTERN_C void __clove_string_ellipse(const char* string, size_t str_len,
                                             size_t pos, char* out,
                                             size_t out_size);
__CLOVE_EXTERN_C void __clove_string_replace_char(char* path, char find,
                                                  char replace);
__CLOVE_EXTERN_C void __clove_string_pad_right(char* dest, size_t dest_size,
                                               size_t str_target_len);
__CLOVE_EXTERN_C int __clove_string_last_indexof(const char* source,
                                                 char character);
...
__CLOVE_EXTERN_C __clove_string_view_t __clove_string_view_from_offs(
  const char* source, size_t begin_offset, size_t end_offset);
__CLOVE_EXTERN_C __clove_string_view_t
__clove_string_view_from_be(const char* begin, const char* end);
__CLOVE_EXTERN_C __clove_string_view_t
__clove_string_view_from_len(const char* begin, size_t length);
__CLOVE_EXTERN_C __clove_string_view_t
__clove_string_view_from_str(const char* str);
__CLOVE_EXTERN_C size_t
__clove_string_view_length(const __clove_string_view_t* view);
__CLOVE_EXTERN_C bool
__clove_string_view_equals(const __clove_string_view_t* view1,
                           const __clove_string_view_t* view2);
__CLOVE_EXTERN_C bool
__clove_string_view_ncmp(const __clove_string_view_t* view1,
                         const __clove_string_view_t* view2, size_t count);
__CLOVE_EXTERN_C bool
__clove_string_view_endswith(const __clove_string_view_t* view,
                             const __clove_string_view_t* suffix);
__CLOVE_EXTERN_C bool
__clove_string_view_nendswith(const __clove_string_view_t* view,
                              const __clove_string_view_t* suffix,
                              size_t suffix_begin_offset);
__CLOVE_EXTERN_C bool
__clove_string_view_strequals(const __clove_string_view_t* view,
                              const char* str);
__CLOVE_EXTERN_C const char*
__clove_string_view_begin(const __clove_string_view_t* view);
__CLOVE_EXTERN_C const char*
__clove_string_view_end(const __clove_string_view_t* view);
__CLOVE_EXTERN_C char*
__clove_string_view_as_string(const __clove_string_view_t* view);
__CLOVE_EXTERN_C char __clove_string_view_at(const __clove_string_view_t* view,
                                             size_t index);
__CLOVE_EXTERN_C bool
__clove_string_view_contains(const __clove_string_view_t* view,
                             const __clove_string_view_t* fixture);
...
__CLOVE_EXTERN_C __clove_time_t __clove_time_sub(__clove_time_t* t1,
                                                 __clove_time_t* t2);
__CLOVE_EXTERN_C __clove_time_t __clove_time_sum(__clove_time_t* t1,
                                                 __clove_time_t* t2);
...
// Stack isn't generalized. By now just managing size_t items by implementing
// Iterative QuickSort
...
__CLOVE_EXTERN_C void __clove_stack_init(__clove_stack_t* stack,
...
__CLOVE_EXTERN_C __clove_vector_params_t
__clove_vector_params_defaulted(size_t item_size);
__CLOVE_EXTERN_C __clove_vector_t __clove_vector_null(void);
__CLOVE_EXTERN_C void __clove_vector_init(__clove_vector_t* vector,
...
__CLOVE_EXTERN_C void __clove_vector_add_all(__clove_vector_t* vector,
                                             const __clove_vector_t* other);
__CLOVE_EXTERN_C void* __clove_vector_get(const __clove_vector_t* vector,
                                          size_t index);
__CLOVE_EXTERN_C void __clove_vector_set(__clove_vector_t* vector, size_t index,
                                         void* item);
__CLOVE_EXTERN_C void __clove_vector_free(__clove_vector_t* vector);
__CLOVE_EXTERN_C void __clove_vector_swap(__clove_vector_t* vector,
                                          size_t index1, size_t index2);
__CLOVE_EXTERN_C size_t __clove_vector_quicksort_partition(
  __clove_vector_t* vector, int (*comparator)(void*, void*), size_t start_index,
  size_t end_index);
__CLOVE_EXTERN_C void
__clove_vector_quicksort_iterative(__clove_vector_t* vector,
                                   int (*comparator)(void*, void*),
                                   size_t start_index, size_t end_index);
__CLOVE_EXTERN_C void __clove_vector_sort(__clove_vector_t* vector,
                                          int (*comparator)(void*, void*));
__CLOVE_EXTERN_C void __clove_vector_collection_dtor(void* vector);

#define __CLOVE_VECTOR_INIT(VECTOR_PTR, TYPE)                                  \
    __clove_vector_params_t __CLOVE_MACRO_COMBINE(params, __LINE__) =          \
      __clove_vector_params_defaulted(sizeof(TYPE));                           \
...
#define __CLOVE_VECTOR_ADD(VECTOR_PTR, TYPE, ITEM)                             \
    TYPE* __CLOVE_MACRO_COMBINE(__vector_slot, __LINE__) =                     \
      (TYPE*)__clove_vector_add_slot(VECTOR_PTR);                              \
    *__CLOVE_MACRO_COMBINE(__vector_slot, __LINE__) = ITEM;

#define __CLOVE_VECTOR_FOREACH(VECTOR_PTR, TYPE, NAME, BODY)                   \
    for (size_t __CLOVE_MACRO_COMBINE(                                         \
           __CLOVE_MACRO_COMBINE(vector_index_, NAME), __LINE__) = 0;          \
         __CLOVE_MACRO_COMBINE(__CLOVE_MACRO_COMBINE(vector_index_, NAME),     \
                               __LINE__) < __clove_vector_count(VECTOR_PTR);   \
         ++__CLOVE_MACRO_COMBINE(__CLOVE_MACRO_COMBINE(vector_index_, NAME),   \
                                 __LINE__))                                    \
    {                                                                          \
        TYPE* NAME = (TYPE*)__clove_vector_get(                                \
          VECTOR_PTR,                                                          \
          __CLOVE_MACRO_COMBINE(__CLOVE_MACRO_COMBINE(vector_index_, NAME),    \
                                __LINE__));                                    \
        BODY                                                                   \
...
#define __CLOVE_VECTOR_FREE(VECTOR_PTR) __clove_vector_free(VECTOR_PTR);
...
#define __CLOVE_MAP_INIT(MAP_PTR)                                              \
    __clove_map_params_t __CLOVE_MACRO_COMBINE(params, __LINE__) =             \
...
__CLOVE_EXTERN_C void __clove_cmdline_init(__clove_cmdline_t* cmdline,
                                           const char** argv, int argc);
__CLOVE_EXTERN_C void __clove_cmdline_free(__clove_cmdline_t* cmdline);
__CLOVE_EXTERN_C bool __clove_cmdline_next_opt(__clove_cmdline_t* cmdline,
                                               const char** opt_out);
__CLOVE_EXTERN_C bool __clove_cmdline_next_arg(__clove_cmdline_t* cmdline,
                                               const char** arg_out);
__CLOVE_EXTERN_C bool __clove_cmdline_has_opt(__clove_cmdline_t* cmdline,
                                              const char* opt);
__CLOVE_EXTERN_C bool __clove_cmdline_has_any_opt(__clove_cmdline_t* cmdline,
                                                  const char* opt1,
                                                  const char* opt2);
__CLOVE_EXTERN_C const char*
__clove_cmdline_get_opt_value(__clove_cmdline_t* cmdline, const char* opt);
__CLOVE_EXTERN_C const char*
__clove_cmdline_get_any_opt_value(__clove_cmdline_t* cmdline, const char* opt1,
                                  const char* opt2);
__CLOVE_EXTERN_C const char*
__clove_cmdline_get_any_opt_value_defaulted(__clove_cmdline_t* cmdline,
                                            const char* opt1, const char* opt2,
                                            const char* default_value);
__CLOVE_EXTERN_C const __clove_vector_t*
__clove_cmdline_get_opt_values(__clove_cmdline_t* cmdline, const char* opt);
__CLOVE_EXTERN_C void __clove_cmdline_add_opt(__clove_cmdline_t* cmd,
                                              const char* opt,
                                              const char* value);
// Command Handlers
typedef __clove_cmdline_errno_t (*__clove_cmdline_handler_f)(
  __clove_cmdline_t*);
__CLOVE_EXTERN_C __clove_cmdline_errno_t
__clove_cmdline_handle_help(__clove_cmdline_t* cmd);
__CLOVE_EXTERN_C __clove_cmdline_errno_t
__clove_cmdline_handle_version(__clove_cmdline_t* cmd);
__CLOVE_EXTERN_C __clove_cmdline_errno_t
__clove_cmdline_handle_run_tests(__clove_cmdline_t* cmd);
__CLOVE_EXTERN_C __clove_cmdline_errno_t
__clove_cmdline_handle_default(__clove_cmdline_t* cmd);
__CLOVE_EXTERN_C void
__clove_cmdline_create_test_expr(__clove_cmdline_t* cmd, const char* opt1,
                                 const char* opt2,
                                 __clove_vector_t* out_expressions);
...
/* TODO: Delete in favor of a crazy custom implementation of string enum... (See
below) typedef enum __clove_generic_type_e {
...
typedef struct __clove_test_t
{
    ...
    struct
    {
        ...
        unsigned char floating_precision; // Just used for float/double to
                                          // represent a decimal digit.
        // TODO Eventually refactor to a data struct to represent
        // expected/actual and encapsulate also __clove_generic_u.
    } issue;
} __clove_test_t;
...
#define __CLOVE_ASSERT_GUARD                                                   \
    if (_this->result == __CLOVE_TEST_RESULT_FAILED)                           \
    {                                                                          \
        return;                                                                \
    }                                                                          \
...
#define __CLOVE_ASSERT_INTEGER_CHECK(mode, exp, act, type, field, test)        \
    ...
    if (check_mode == __CLOVE_ASSERT_EQ)                                       \
    {                                                                          \
        pass_scenario = exp == act;                                            \
    }                                                                          \
    else if (check_mode == __CLOVE_ASSERT_NE)                                  \
    {                                                                          \
        pass_scenario = exp != act;                                            \
    }                                                                          \
    else if (check_mode == __CLOVE_ASSERT_GT)                                  \
    {                                                                          \
        pass_scenario = exp > act;                                             \
    }                                                                          \
    else if (check_mode == __CLOVE_ASSERT_GTE)                                 \
    {                                                                          \
        pass_scenario = exp >= act;                                            \
    }                                                                          \
    else if (check_mode == __CLOVE_ASSERT_LT)                                  \
    {                                                                          \
        pass_scenario = exp < act;                                             \
    }                                                                          \
    else if (check_mode == __CLOVE_ASSERT_LTE)                                 \
    {                                                                          \
        pass_scenario = exp <= act;                                            \
    }                                                                          \
    if (pass_scenario)                                                         \
...
__CLOVE_EXTERN_C void __clove_assert_int(__clove_assert_check_e check_mode,
                                         int expected, int result,
                                         __clove_test_t* _this);
__CLOVE_EXTERN_C void __clove_assert_uint(__clove_assert_check_e check_mode,
                                          unsigned int expected,
                                          unsigned int result,
                                          __clove_test_t* _this);
__CLOVE_EXTERN_C void __clove_assert_long(__clove_assert_check_e check_mode,
                                          long expected, long result,
                                          __clove_test_t* _this);
__CLOVE_EXTERN_C void __clove_assert_ulong(__clove_assert_check_e check_mode,
                                           unsigned long expected,
                                           unsigned long result,
                                           __clove_test_t* _this);
__CLOVE_EXTERN_C void __clove_assert_llong(__clove_assert_check_e check_mode,
                                           long long expected, long long result,
                                           __clove_test_t* _this);
__CLOVE_EXTERN_C void __clove_assert_ullong(__clove_assert_check_e check_mode,
                                            unsigned long long expected,
                                            unsigned long long result,
                                            __clove_test_t* _this);
__CLOVE_EXTERN_C void __clove_assert_sizet(__clove_assert_check_e check_mode,
                                           size_t expected, size_t result,
                                           __clove_test_t* _this);
__CLOVE_EXTERN_C void __clove_assert_char(__clove_assert_check_e check_mode,
                                          char expected, char result,
                                          __clove_test_t* _this);
__CLOVE_EXTERN_C void __clove_assert_bool(__clove_assert_check_e check_mode,
                                          bool expected, bool result,
                                          __clove_test_t* _this);
__CLOVE_EXTERN_C void __clove_assert_null(__clove_assert_check_e check_mode,
                                          void* expected, void* result,
                                          __clove_test_t* _this);
__CLOVE_EXTERN_C void __clove_assert_ptr(__clove_assert_check_e check_mode,
                                         void* expected, void* result,
                                         __clove_test_t* _this);
__CLOVE_EXTERN_C void __clove_assert_float(__clove_assert_check_e check_mode,
                                           float expected, float result,
                                           unsigned char precision,
                                           __clove_test_t* _this);
__CLOVE_EXTERN_C void __clove_assert_double(__clove_assert_check_e check_mode,
                                            double expected, double result,
                                            unsigned char precision,
                                            __clove_test_t* _this);
__CLOVE_EXTERN_C void __clove_assert_string(__clove_assert_check_e check_mode,
                                            const char* expected,
                                            const char* result,
                                            __clove_test_t* _this);
...
__CLOVE_EXTERN_C void __clove_stream_console_writef(__clove_stream_t* stream,
                                                    const char* format, ...);
__CLOVE_EXTERN_C void __clove_stream_console_seek(__clove_stream_t* stream,
                                                  long offset, int origin);
__CLOVE_EXTERN_C bool
__clove_stream_console_has_ansi_support(struct __clove_stream_t* _this);
...
typedef struct __clove_stream_file_t
{
    ...
    FILE* file; // No way to forward declaring FILE. The only way should be to
                // use void*
} __clove_stream_file_t;

__CLOVE_EXTERN_C __clove_stream_file_t*
__clove_stream_file_new(const char* file_path);
...
__CLOVE_EXTERN_C void __clove_stream_file_writef(__clove_stream_t* stream,
                                                 const char* format, ...);
__CLOVE_EXTERN_C void __clove_stream_file_seek(__clove_stream_t* stream,
                                               long offset, int origin);
__CLOVE_EXTERN_C bool
__clove_stream_file_has_ansi_support(struct __clove_stream_t* _this);
...
__CLOVE_EXTERN_C void __clove_stream_memory_writef(__clove_stream_t* stream,
                                                   const char* format, ...);
__CLOVE_EXTERN_C void __clove_stream_memory_seek(__clove_stream_t* stream,
                                                 long offset, int origin);
__CLOVE_EXTERN_C bool
__clove_stream_memory_has_ansi_support(struct __clove_stream_t* _this);
__CLOVE_EXTERN_C void __clove_stream_memory_free(__clove_stream_t* stream);
__CLOVE_EXTERN_C char*
__clove_stream_memory_get_line(__clove_stream_memory_t* mem_stream,
                               size_t index);
__CLOVE_EXTERN_C char*
__clove_stream_memory_as_string(__clove_stream_memory_t* mem_stream);
#pragma endregion // Stream Decl

#pragma region PRIVATE - Report Decl
typedef struct __clove_report_t
{
    void (*start)(struct __clove_report_t* _this, __clove_vector_t* suites,
                  size_t test_count);
    void (*end)(struct __clove_report_t* _this, size_t passed, size_t skipped,
                size_t failed);
    void (*begin_suite)(struct __clove_report_t* _this, __clove_suite_t* suite,
                        size_t index);
    void (*end_suite)(struct __clove_report_t* _this, __clove_suite_t* suite,
                      size_t index);
    void (*end_test)(struct __clove_report_t* _this, __clove_suite_t* suite,
                     __clove_test_t* test, size_t test_number);
...
__CLOVE_EXTERN_C void __clove_test_expr_init(__clove_test_expr_t* expr,
                                             const char* expr_str);
__CLOVE_EXTERN_C bool
__clove_test_expr_validate_vw(const __clove_string_view_t* match,
                              const __clove_string_view_t* view);
__CLOVE_EXTERN_C bool
__clove_test_expr_validate(__clove_test_expr_t* expr,
                           const __clove_string_view_t* suite,
                           const __clove_string_view_t* test);
#pragma endregion
...
__clove_report_pretty_t*
__clove_report_run_tests_pretty_new(__clove_stream_t* stream,
                                    __clove_report_params_t* params);
__CLOVE_EXTERN_C void __clove_report_pretty_free(__clove_report_t* report);
__CLOVE_EXTERN_C void __clove_report_pretty_start(__clove_report_t* _this,
                                                  __clove_vector_t* suites,
                                                  size_t test_count);
__CLOVE_EXTERN_C void __clove_report_pretty_begin_suite(__clove_report_t* _this,
                                                        __clove_suite_t* suite,
                                                        size_t index);
__CLOVE_EXTERN_C void __clove_report_pretty_end_suite(__clove_report_t* _this,
                                                      __clove_suite_t* suite,
                                                      size_t index);
__CLOVE_EXTERN_C void __clove_report_pretty_end_test(__clove_report_t* _this,
                                                     __clove_suite_t* suite,
                                                     __clove_test_t* test,
                                                     size_t test_number);
__CLOVE_EXTERN_C void __clove_report_pretty_end(__clove_report_t* _this,
                                                size_t passed, size_t skipped,
                                                size_t failed);
__CLOVE_EXTERN_C void __clove_report_pretty_string_ellipse(
  const char* exp, size_t exp_len, const char* act, size_t act_len,
  char* exp_short, char* act_short, size_t short_size);
#define __CLOVE_STRING_LENGTH 256
#define __PRETTY_PRINT_FAIL_ASSERT_MSG(buffer, buffer_size, assert, exp, act,  \
                                       print_type)                             \
    {                                                                          \
        char phrase_format[40] = {0};                                          \
        if (assert == __CLOVE_ASSERT_EQ)                                       \
            __clove_string_sprintf(phrase_format, sizeof(phrase_format),       \
                                   "expected [%s] but was [%s]", print_type,   \
                                   print_type);                                \
        else if (assert == __CLOVE_ASSERT_NE)                                  \
            __clove_string_sprintf(phrase_format, sizeof(phrase_format),       \
                                   "not expected [%s] but was [%s]",           \
                                   print_type, print_type);                    \
        else if (assert == __CLOVE_ASSERT_GT)                                  \
            __clove_string_sprintf(phrase_format, sizeof(phrase_format),       \
                                   "expected [%s > %s] but wasn't",            \
                                   print_type, print_type);                    \
        else if (assert == __CLOVE_ASSERT_GTE)                                 \
            __clove_string_sprintf(phrase_format, sizeof(phrase_format),       \
                                   "expected [%s >= %s] but wasn't",           \
                                   print_type, print_type);                    \
        else if (assert == __CLOVE_ASSERT_LT)                                  \
            __clove_string_sprintf(phrase_format, sizeof(phrase_format),       \
                                   "expected [%s < %s] but wasn't",            \
                                   print_type, print_type);                    \
        else if (assert == __CLOVE_ASSERT_LTE)                                 \
            __clove_string_sprintf(phrase_format, sizeof(phrase_format),       \
                                   "expected [%s <= %s] but wasn't",           \
                                   print_type, print_type);                    \
...
__clove_report_run_tests_csv_t*
__clove_report_run_tests_csv_new(__clove_stream_t* stream,
                                 __clove_report_params_t* params);
__CLOVE_EXTERN_C void
__clove_report_run_tests_csv_free(__clove_report_t* report);
__CLOVE_EXTERN_C void
__clove_report_run_tests_csv_start(__clove_report_t* _this,
                                   __clove_vector_t* suites, size_t test_count);
__CLOVE_EXTERN_C void
__clove_report_run_tests_csv_begin_suite(__clove_report_t* _this,
                                         __clove_suite_t* suite, size_t index);
__CLOVE_EXTERN_C void
__clove_report_run_tests_csv_end_suite(__clove_report_t* _this,
                                       __clove_suite_t* suite, size_t index);
__CLOVE_EXTERN_C void
__clove_report_run_tests_csv_end_test(__clove_report_t* _this,
                                      __clove_suite_t* suite,
                                      __clove_test_t* test, size_t test_number);
__CLOVE_EXTERN_C void __clove_report_run_tests_csv_end(__clove_report_t* _this,
                                                       size_t passed,
                                                       size_t skipped,
                                                       size_t failed);
__CLOVE_EXTERN_C void
__clove_report_run_tests_csv_print_data(__clove_report_run_tests_csv_t* _this,
                                        __clove_test_t* test,
                                        __clove_generic_u* data);
#pragma endregion
...
__CLOVE_EXTERN_C __clove_report_json_t*
__clove_report_run_tests_json_new(__clove_stream_t* stream,
                                  __clove_report_params_t* params);
__CLOVE_EXTERN_C void __clove_report_json_free(__clove_report_t* report);
__CLOVE_EXTERN_C void __clove_report_json_start(__clove_report_t* _this,
                                                __clove_vector_t* suites,
                                                size_t test_count);
__CLOVE_EXTERN_C void __clove_report_json_begin_suite(__clove_report_t* _this,
                                                      __clove_suite_t* suite,
                                                      size_t index);
__CLOVE_EXTERN_C void __clove_report_json_end_suite(__clove_report_t* _this,
                                                    __clove_suite_t* suite,
                                                    size_t index);
__CLOVE_EXTERN_C void __clove_report_json_end(__clove_report_t* _this,
                                              size_t passed, size_t skipped,
                                              size_t failed);
__CLOVE_EXTERN_C void __clove_report_json_end_test(__clove_report_t* _this,
                                                   __clove_suite_t* suite,
                                                   __clove_test_t* test,
                                                   size_t test_number);
__CLOVE_EXTERN_C void
__clove_report_json_print_data(__clove_report_json_t* _this,
                               __clove_test_t* test, __clove_generic_u* data);
#pragma endregion

#pragma region PRIVATE - Report List Test Decl
typedef struct __clove_report_list_tests_t
{
    void (*begin)(struct __clove_report_list_tests_t* _this, size_t suite_count,
                  size_t test_count);
    void (*begin_suite)(struct __clove_report_list_tests_t* _this,
                        __clove_suite_t* suite, size_t index);
    void (*begin_test)(struct __clove_report_list_tests_t* _this,
                       __clove_test_t* test, size_t index);
    void (*end_test)(struct __clove_report_list_tests_t* _this,
                     __clove_test_t* test, size_t index);
    void (*end_suite)(struct __clove_report_list_tests_t* _this,
                      __clove_suite_t* suite, size_t index);
...
__clove_report_list_tests_pretty_t*
__clove_report_list_tests_pretty_new(__clove_stream_t* stream,
                                     __clove_report_params_t* params);
void __clove_report_list_tests_pretty_free(__clove_report_list_tests_t* _this);
void __clove_report_list_tests_pretty_begin(__clove_report_list_tests_t* _this,
                                            size_t suite_count,
                                            size_t test_count);
void __clove_report_list_tests_pretty_begin_suite(
  __clove_report_list_tests_t* _this, __clove_suite_t* suite, size_t index);
void __clove_report_list_tests_pretty_end_suite(
  __clove_report_list_tests_t* _this, __clove_suite_t* suite, size_t index);
void __clove_report_list_tests_pretty_begin_test(
  __clove_report_list_tests_t* _this, __clove_test_t* test, size_t index);
void __clove_report_list_tests_pretty_end_test(
  __clove_report_list_tests_t* _this, __clove_test_t* test, size_t index);
...
__clove_report_list_tests_csv_t*
__clove_report_list_tests_csv_new(__clove_stream_t* stream,
                                  __clove_report_params_t* params);
void __clove_report_list_tests_csv_free(__clove_report_list_tests_t* _this);
void __clove_report_list_tests_csv_begin(__clove_report_list_tests_t* _this,
                                         size_t suite_count, size_t test_count);
void __clove_report_list_tests_csv_begin_suite(
  __clove_report_list_tests_t* _this, __clove_suite_t* suite, size_t index);
void __clove_report_list_tests_csv_end_suite(__clove_report_list_tests_t* _this,
                                             __clove_suite_t* suite,
                                             size_t index);
void __clove_report_list_tests_csv_begin_test(
  __clove_report_list_tests_t* _this, __clove_test_t* test, size_t index);
void __clove_report_list_tests_csv_end_test(__clove_report_list_tests_t* _this,
                                            __clove_test_t* test, size_t index);
...
__clove_report_list_tests_json_t*
__clove_report_list_tests_json_new(__clove_stream_t* stream,
                                   __clove_report_params_t* params);
void __clove_report_list_tests_json_free(__clove_report_list_tests_t* _this);
void __clove_report_list_tests_json_begin(__clove_report_list_tests_t* _this,
                                          size_t suite_count,
                                          size_t test_count);
void __clove_report_list_tests_json_begin_suite(
  __clove_report_list_tests_t* _this, __clove_suite_t* suite, size_t index);
void __clove_report_list_tests_json_end_suite(
  __clove_report_list_tests_t* _this, __clove_suite_t* suite, size_t index);
void __clove_report_list_tests_json_begin_test(
  __clove_report_list_tests_t* _this, __clove_test_t* test, size_t index);
void __clove_report_list_tests_json_end_test(__clove_report_list_tests_t* _this,
                                             __clove_test_t* test,
                                             size_t index);
void __clove_report_list_tests_json_end(__clove_report_list_tests_t* _this);

int __clove_cmd_list_test_execute(__clove_suite_t* suites, size_t suite_count,
                                  size_t test_count,
...
{
    char* name;
    // Using union just to avoid explicit casting from object ptr to function
    // ptr 'void* to void(*)()' which emit warning using -Wpedantic flag with
    // GCC compiler.
    union
    {
        void* obj_ptr;
...
__CLOVE_EXTERN_C bool __clove_symbols_function_validate(
  __clove_string_view_t* suite, __clove_string_view_t* type,
  __clove_string_view_t* name, __clove_symbols_context_t* context);
__CLOVE_EXTERN_C void
__clove_symbols_function_collect(__clove_symbols_function_t exported_funct,
                                 __clove_symbols_context_t* context);
// For each OS / symbols table format
__CLOVE_EXTERN_C typedef void (*__clove_symbols_function_action)(
  __clove_symbols_function_t, __clove_symbols_context_t* context);
__CLOVE_EXTERN_C int __clove_symbols_for_each_function_by_prefix(
  __clove_symbols_context_t* context, __clove_symbols_function_action action);
...
__CLOVE_EXTERN_C int __clove_exec_suites(__clove_vector_t* suites,
                                         size_t test_count,
                                         __clove_report_t* report);
__CLOVE_EXTERN_C void __clove_exec_suite(__clove_suite_t* suite,
                                         size_t test_counter, size_t* passed,
                                         size_t* failed, size_t* skipped,
                                         __clove_report_t* report);
...
// Note: Not exported for windows (symbol limit 65535). Even "extern c"
// directive is not needed
//       Furthermore using prefix __clove_symint__ so that this kind of function
//       is excluded from Symbol Discovery
#define __CLOVE_SUITE_METHOD_INTERNAL_DECL_2(suite, title, param)              \
    void __clove_symint___##suite##___##title(param)
#define __CLOVE_SUITE_METHOD_INTERNAL_DECL_1(suite, name, param)               \
    __CLOVE_SUITE_METHOD_INTERNAL_DECL_2(suite, name, param)
#define __CLOVE_SUITE_METHOD_INTERNAL_INVOKE_2(suite, title, param)            \
    __clove_symint___##suite##___##title(param)
#define __CLOVE_SUITE_METHOD_INTERNAL_INVOKE_1(suite, title, param)            \
    __CLOVE_SUITE_METHOD_INTERNAL_INVOKE_2(suite, title, param)

#define __CLOVE_SUITE_METHOD_DECL_2(suite, title, param)                       \
    __CLOVE_API_EXPORT void __clove_sym___##suite##___##title(param)
#define __CLOVE_SUITE_METHOD_DECL_1(suite, name, param)                        \
    __CLOVE_SUITE_METHOD_DECL_2(suite, name, param)

#define __CLOVE_SUITE_SETUP_ONCE_AUTO()                                        \
    __CLOVE_SUITE_METHOD_DECL_1(CLOVE_SUITE_NAME, 11_setuponce, void)
#define __CLOVE_SUITE_TEARDOWN_ONCE_AUTO()                                     \
    __CLOVE_SUITE_METHOD_DECL_1(CLOVE_SUITE_NAME, 12_teardownonce, void)
#define __CLOVE_SUITE_SETUP_AUTO()                                             \
    __CLOVE_SUITE_METHOD_DECL_1(CLOVE_SUITE_NAME, 13_setup, void)
#define __CLOVE_SUITE_TEARDOWN_AUTO()                                          \
    __CLOVE_SUITE_METHOD_DECL_1(CLOVE_SUITE_NAME, 14_teardown, void)
#define __CLOVE_TEST_AUTO(title)                                               \
    __CLOVE_SUITE_METHOD_INTERNAL_DECL_1(CLOVE_SUITE_NAME, 21_##title,         \
                                         __clove_test_t* _this);               \
    __CLOVE_SUITE_METHOD_DECL_1(CLOVE_SUITE_NAME, 20_##title,                  \
                                __clove_test_t* _this)                         \
    {                                                                          \
        _this->file_name = __FILE__;                                           \
        _this->funct_line = __LINE__;                                          \
        if (_this->dry_run) return;                                            \
        __CLOVE_SUITE_METHOD_INTERNAL_INVOKE_1(CLOVE_SUITE_NAME, 21_##title,   \
                                               _this);                         \
    }                                                                          \
    __CLOVE_SUITE_METHOD_INTERNAL_DECL_1(CLOVE_SUITE_NAME, 21_##title,         \
                                         __clove_test_t* _this)
...
char* __clove_path_concat(const char* path1, const char* path2,
                          const char separator)
{
    size_t count =
      __clove_string_length(path1) + 1 + __clove_string_length(path2) + 1;
...
char* __clove_path_rel_to_abs_exec_path(const char* rel_path)
{
    ...
    char* abs_path =
      __clove_path_concat(base_path, rel_path, __CLOVE_PATH_SEPARATOR);
    return abs_path;
}

bool __clove_path_is_relative(const char* path)
{
    if (__clove_string_startswith(path, "\\"))
        return false; // windows (match the main unit)
    if (__clove_string_length(path) > 2 && path[1] == ':')
        return false; // windows (contains unit:)
...
char* __clove_path_basepath(const char* path)
{
    ...
    int last_char_uni =
      __clove_string_last_indexof(temp_path, '/'); // or unix or win eventually
    int last_char_index =
      last_char_win > last_char_uni ? last_char_win : last_char_uni;

    // If there are no separators in the path, return the current directory
    // path.
    char* result = NULL;
    ...
    {
        // Calculate base path length based on the position of the last path
        // separator.
        size_t base_length = (size_t)(last_char_index + 1);
        char* base_path = __CLOVE_MEMORY_CALLOC_TYPE_N(char, base_length);
        __clove_string_strncpy(base_path, base_length, temp_path,
                               base_length - 1);
...
#include <string.h>
void* __clove_memory_malloc(size_t size) { return malloc(size); }

void* __clove_memory_calloc(size_t size) { return calloc(1, size); }
...
bool __clove_memory_memcpy(void* dest, size_t dest_size, const void* src,
                           size_t src_size)
{
#ifdef _WIN32
...
void __clove_memory_free(void* source) { free(source); }
...
bool __clove_string_strncpy(char* dest, size_t dest_size, const char* source,
                            size_t count)
{
#ifdef _WIN32
...
bool __clove_string_strncat(char* dest, size_t dest_size, const char* source,
                            size_t count)
{
#ifdef _WIN32
...
void __clove_string_vsprintf(char* dest, size_t dest_size, const char* format,
                             va_list args)
{
#ifdef _WIN32
    vsnprintf_s(dest, dest_size, dest_size, format, args);
...
size_t __clove_string_length(const char* str) { return strlen(str); }
...
char* __clove_string_csv_escape(const char* string)
{
    size_t str_len = __clove_string_length(string);
    size_t esc_len =
      str_len * 2 + 2 + 1; // worst case where each char need escape + 2 for
                           // string who need to be enclosed in double quotes
    char* escaped = __CLOVE_MEMORY_CALLOC_TYPE_N(char, esc_len);
...
void __clove_string_ellipse(const char* string, size_t str_len, size_t pos,
...
void __clove_string_pad_right(char* dest, size_t dest_size,
                              size_t str_target_len)
{
...
#include <stdlib.h>
__clove_string_view_t __clove_string_view_from_offs(const char* source,
                                                    size_t begin_offset,
                                                    size_t end_offset)
{
...
__clove_string_view_t __clove_string_view_from_be(const char* begin,
                                                  const char* end)
{
    return __clove_string_view_from_offs(begin, 0, end - begin);
}

__clove_string_view_t __clove_string_view_from_len(const char* begin,
                                                   size_t length)
{
...
{
    return __clove_string_view_from_offs(str, 0,
                                         __clove_string_length(str) - 1);
}
...
bool __clove_string_view_equals(const __clove_string_view_t* view1,
                                const __clove_string_view_t* view2)
{
    if (view1->length != view2->length) return false;
    return strncmp(view1->begin, view2->begin, view1->length) ==
           0; // richiamare ncmp
}

bool __clove_string_view_ncmp(const __clove_string_view_t* view1,
                              const __clove_string_view_t* view2, size_t count)
{
    return __clove_string_strncmp(view1->begin, view2->begin, count);
}

bool __clove_string_view_endswith(const __clove_string_view_t* view,
                                  const __clove_string_view_t* suffix)
{
...
bool __clove_string_view_nendswith(const __clove_string_view_t* view,
                                   const __clove_string_view_t* suffix,
                                   size_t suffix_begin_offset)
{
    __clove_string_view_t suffix_with_offset = __clove_string_view_from_be(
      suffix->begin + suffix_begin_offset, __clove_string_view_end(suffix));
    return __clove_string_view_endswith(view, &suffix_with_offset);
}

bool __clove_string_view_strequals(const __clove_string_view_t* view,
                                   const char* str)
{
...
{
    char* str = (char*)__clove_memory_malloc(view->length +
                                             1); // size+1 for null terminator
...
bool __clove_string_view_contains(const __clove_string_view_t* view,
                                  const __clove_string_view_t* fixture)
{
    ...
    {
        if (__clove_string_strncmp(view->begin + index, fixture->begin,
                                   fixture->length))
            return true;
        residual_length--;
        index++;
...
__clove_time_t __clove_time_sub(__clove_time_t* t1, __clove_time_t* t2)
{
    ...
    result.nanos_after_seconds =
      t1->nanos_after_seconds - t2->nanos_after_seconds;
...
__clove_time_t __clove_time_now(void)
{
    ...
    result.nanos_after_seconds = ((count.QuadPart % count_per_sec.QuadPart) *
                                  __CLOVE_TIME_TRANSL_NANOS_PER_SEC) /
                                 count_per_sec.QuadPart;
    return result;
}
#else
#include <time.h>
...
void __clove_stack_init(__clove_stack_t* stack, size_t initial_capacity)
{
    ...
    stack->items =
      (unsigned char*)__clove_memory_malloc(stack->item_size * stack->capacity);
}
...
void __clove_stack_push(__clove_stack_t* stack, size_t item)
{
    ...
    {
        stack->capacity *= 2;
        stack->items = (unsigned char*)__clove_memory_realloc(
          stack->items, stack->item_size * stack->capacity);
    }
...
void __clove_vector_init(__clove_vector_t* vector,
                         __clove_vector_params_t* params)
{
    vector->capacity = params->initial_capacity;
    vector->count = 0;
    vector->item_size = params->item_size;
    vector->items = (unsigned char*)__clove_memory_malloc(vector->item_size *
                                                          vector->capacity);
...
void* __clove_vector_add_slot(__clove_vector_t* vector)
{
    ...
    {
        vector->capacity *= 2;
        vector->items = (unsigned char*)__clove_memory_realloc(
          vector->items, vector->item_size * vector->capacity);
    }
...
void __clove_vector_add_all(__clove_vector_t* vector,
                            const __clove_vector_t* other)
{
...
void __clove_vector_swap(__clove_vector_t* vector, size_t index1, size_t index2)
{
    ...
    if (!curr || !next) return;
    __clove_memory_memcpy(vector->swap_temp, vector->item_size, curr,
                          vector->item_size);
...
// QuickSort
size_t __clove_vector_quicksort_partition(__clove_vector_t* vector,
                                          int (*comparator)(void*, void*),
                                          size_t start_index, size_t end_index)
{
...
void __clove_vector_quicksort_iterative(__clove_vector_t* vector,
                                        int (*comparator)(void*, void*),
                                        size_t start_index, size_t end_index)
{
    ...
    while (!__clove_stack_is_empty(&index_pairs_stack))
    {
        ...
        size_t pivot_index = __clove_vector_quicksort_partition(
          vector, comparator, start_index, end_index);

        // left array indexes
        if (pivot_index != 0)
        { // protect size_t overflow (for instance, this happens for already
          // sorted items)
            __clove_stack_push(&index_pairs_stack, start_index);
        ...
        { // protect size_t overflow (for symmetry)
            __clove_stack_push(&index_pairs_stack, pivot_index + 1);
            __clove_stack_push(&index_pairs_stack, end_index);
        }
    }
...
void __clove_vector_sort(__clove_vector_t* vector,
                         int (*comparator)(void*, void*))
{
    if (vector->count <= 1) return;
    __clove_vector_quicksort_iterative(vector, comparator, 0,
                                       vector->count - 1);
}
...
void __clove_map_init(__clove_map_t* map, __clove_map_params_t* params)
{
    ...
    map->hashmap =
      __CLOVE_MEMORY_CALLOC_TYPE_N(__clove_map_node_t*, map->hashmap_size);
...
void __clove_map_free(__clove_map_t* map)
{
    for (size_t i = 0; i < map->hashmap_size; ++i)
    {
        ...
        while (current)
        {
            ...
            if (map->item_dtor)
            {
                // if dtor set, means map become owner of the item (and its
                // memory)
...
size_t __clove_map_count(__clove_map_t* map) { return map->count; }
...
void __clove_map_put(__clove_map_t* dict, const char* key, void* value)
{
    ...
    {
        __clove_map_node_t* node =
          __CLOVE_MEMORY_MALLOC_TYPE(__clove_map_node_t);
    ...
    { // Scenario 2: hash(Key) already present
        ...
        while (node)
        {
            ...
            if (node->key_size == key_size &&
                __clove_string_equal(key, node->key))
            {
                node->value = value;
                return;
            }
...
bool __clove_cmdline_next_opt(__clove_cmdline_t* cmdline, const char** opt_out)
{
    while (cmdline->arg_index < cmdline->argc)
    {
        ...
        if (__clove_string_startswith(current, "--") &&
            __clove_string_length(current) > 3)
        {
            *opt_out = current + 2;
            return true;
        }
        else if (__clove_string_startswith(current, "-") &&
                 __clove_string_length(current) == 2)
        {
            *opt_out = current + 1;
            return true;
        }
...
void __clove_cmdline_add_opt(__clove_cmdline_t* cmd, const char* opt,
                             const char* value)
{
...
const char* __clove_cmdline_get_opt_value(__clove_cmdline_t* cmdline,
                                          const char* opt)
{
    const __clove_vector_t* values =
      __clove_cmdline_get_opt_values(cmdline, opt);
    if (!values || __clove_vector_count(values) == 0) return NULL;
    return *(char**)__clove_vector_get(values, 0);
}
const __clove_vector_t*
__clove_cmdline_get_opt_values(__clove_cmdline_t* cmdline, const char* opt)
{
    return (__clove_vector_t*)__clove_map_get(&(cmdline->map), opt);
}

bool __clove_cmdline_has_any_opt(__clove_cmdline_t* cmdline, const char* opt1,
                                 const char* opt2)
{
    return __clove_cmdline_has_opt(cmdline, opt1) ||
           __clove_cmdline_has_opt(cmdline, opt2);
}

const char* __clove_cmdline_get_any_opt_value(__clove_cmdline_t* cmdline,
                                              const char* opt1,
                                              const char* opt2)
{
...
{
    if (!__clove_cmdline_has_any_opt(cmd, "h", "help"))
    ...
    printf(
      "%*s%-*s%*s%s\n", 3, " ", 30, "<no-options>", 5, " ",
      "Run all tests producing a 'pretty' print report (default behavior).");
    printf("%*s%-*s%*s%s\n", 3, " ", 30, "-b, --base-path", 5, " ",
           "Base path for test sources. Allow to shorten test file paths when "
           "running/listing tests.");
    printf("%*s%-*s%*s%s\n", 3, " ", 30, "-d, --run-detail <level>", 5, " ",
           "Control Run Tests report detail level: '1' (failed), '2' "
           "(failed+skipped), '3' (passed+failed+skipped). Default is '3'.");
    printf("%*s%-*s%*s%s\n", 3, " ", 30, "-e, --exclude <expr>", 5, " ",
           "Suite/Test expression to be excluded. Works when running/listing "
           "tests.");
    printf("%*s%-*s%*s%s\n", 3, " ", 30, "-h, --help", 5, " ",
           "Display usage information.");
    printf("%*s%-*s%*s%s\n", 3, " ", 30, "-i, --include <expr>", 5, " ",
           "Suite/Test expression to be included. Works when running/listing "
           "tests.");
    printf("%*s%-*s%*s%s\n", 3, " ", 30, "-l, --list-tests", 5, " ",
           "List all/matching test cases in 'pretty' format (default).");
    printf(
      "%*s%-*s%*s%s\n", 3, " ", 30, "-o, --output <stream>", 5, " ",
      "Specify output stream for a report: 'stdout' (default) or <file path>.");
    printf(
      "%*s%-*s%*s%s\n", 3, " ", 30, "-r, --report <format>", 5, " ",
      "Specify a report format when running tests: 'pretty', 'csv', 'json'.");
    printf("%*s%-*s%*s%s\n", 3, " ", 30, "-t, --run-tests", 5, " ",
           "Execute all/matching test cases (same as <no-options>).");
    printf("%*s%-*s%*s%s\n", 3, " ", 30, "-v, --version", 5, " ",
           "Show CLove-Unit version.");
    printf("%*s%-*s%*s%s\n", 3, " ", 30, "-x, --error-on-test-fail", 5, " ",
           "Run Tests process will end with error in case of test failure. "
           "Default is to end the process successfully.");
    printf("\n");
    printf("For detailed usage please look at the README in "
           "https://github.com/fdefelici/clove-unit.\n");
...
{
    if (!__clove_cmdline_has_any_opt(cmd, "v", "version"))
        return __CLOVE_CMD_ERRNO_UNMANAGED;
...
{
    if (!__clove_cmdline_has_any_opt(cmd, "t", "run-tests"))
        return __CLOVE_CMD_ERRNO_UNMANAGED;

    const char* opt_report =
      __clove_cmdline_get_any_opt_value_defaulted(cmd, "r", "report", "pretty");
    if (!__clove_string_equal_any(opt_report, 3, "pretty", "json", "csv"))
        return __CLOVE_CMD_ERRNO_INVALID_PARAM;

    const char* opt_detail =
      __clove_cmdline_get_any_opt_value_defaulted(cmd, "d", "run-detail", "3");
    if (!__clove_string_equal_any(opt_detail, 3, "1", "2", "3"))
        return __CLOVE_CMD_ERRNO_INVALID_PARAM;

    const char* opt_out =
      __clove_cmdline_get_any_opt_value_defaulted(cmd, "o", "output", "stdout");
    const char* opt_base_path =
      __clove_cmdline_get_any_opt_value_defaulted(cmd, "b", "base-path", "");
    const bool opt_enable_error =
      __clove_cmdline_has_any_opt(cmd, "x", "error-on-test-fail");
    ...
    if (__clove_string_equal(opt_detail, "1"))
        ...
        report_params.report_detail =
          __CLOVE_REPORT_DETAIL__PASSED_FAILED_SKIPPED;

    __clove_report_t* report;
    if (__clove_string_equal("json", opt_report))
    {
        report = (__clove_report_t*)__clove_report_run_tests_json_new(
          stream, &report_params);
    }
    else if (__clove_string_equal("pretty", opt_report))
    {
        report = (__clove_report_t*)__clove_report_run_tests_pretty_new(
          stream, &report_params);
    }
    else if (__clove_string_equal("csv", opt_report))
    {
        report = (__clove_report_t*)__clove_report_run_tests_csv_new(
          stream, &report_params);
    }
    else
    {
        // Just to avoid compile warnings. This can never happen because of
        // validation did before.
        return __CLOVE_CMD_ERRNO_UNMANAGED;
    }

    // Run report
    int run_result =
      __clove_run_tests_with_report(report, &includes, &excludes);
...
__clove_cmdline_errno_t
__clove_cmdline_handle_list_tests(__clove_cmdline_t* cmd)
{
    if (!__clove_cmdline_has_any_opt(cmd, "l", "list-tests"))
        return __CLOVE_CMD_ERRNO_UNMANAGED;
    ...
    {
        report =
          (__clove_report_list_tests_t*)__clove_report_list_tests_json_new(
            stream, &report_params);
    }
    else if (__clove_string_equal("pretty", opt_report))
    {
        report =
          (__clove_report_list_tests_t*)__clove_report_list_tests_pretty_new(
            stream, &report_params);
    }
    else if (__clove_string_equal("csv", opt_report))
    {
        report =
          (__clove_report_list_tests_t*)__clove_report_list_tests_csv_new(
            stream, &report_params);
    }
    else
    {
    ...
    __clove_vector_params_t vector_params =
      __clove_vector_params_defaulted(sizeof(__clove_suite_t));
    ...
    int result = __clove_symbols_for_each_function_by_prefix(
      &context, __clove_symbols_function_collect);
    if (result == 0)
    {
        run_result = __clove_cmd_list_test_execute(
          (__clove_suite_t*)(context.suites.items), context.suites_count,
          context.tests_count, report);
    }
    else
    {
        run_result = 1;
...
void __clove_cmdline_create_test_expr(__clove_cmdline_t* cmd, const char* opt1,
                                      const char* opt2,
                                      __clove_vector_t* expressions)
{
    *expressions = __clove_vector_null();
    ...
    if (has_opt1)
    {
        const __clove_vector_t* values1 =
          __clove_cmdline_get_opt_values(cmd, opt1);
        __clove_vector_add_all(&values, values1);
    }
    if (has_opt2)
    {
        const __clove_vector_t* values2 =
          __clove_cmdline_get_opt_values(cmd, opt2);
        __clove_vector_add_all(&values, values2);
    }

    size_t values_count = __clove_vector_count(&values);
    __CLOVE_VECTOR_INIT_CAPACITY(expressions, __clove_test_expr_t,
                                 values_count);
...
void __clove_vector_test_dtor(void* test_ptr)
{
    ...
    if (test->result == __CLOVE_TEST_RESULT_FAILED &&
        test->issue.data_type == __CLOVE_GENERIC_STRING)
    {
...
void __clove_vector_suite_ctor(void* suite_ptr)
{
    ...
    __clove_vector_params_t params =
      __clove_vector_params_defaulted(sizeof(__clove_test_t));
...
void __clove_assert_int(__clove_assert_check_e check_mode, int expected,
                        int result, __clove_test_t* _this)
{
    __CLOVE_ASSERT_INTEGER_CHECK(check_mode, expected, result,
                                 __CLOVE_GENERIC_INT, _int, _this)
}

void __clove_assert_uint(__clove_assert_check_e check_mode,
                         unsigned int expected, unsigned int result,
                         __clove_test_t* _this)
{
    __CLOVE_ASSERT_INTEGER_CHECK(check_mode, expected, result,
                                 __CLOVE_GENERIC_UINT, _uint, _this)
}

void __clove_assert_long(__clove_assert_check_e check_mode, long expected,
                         long result, __clove_test_t* _this)
{
    __CLOVE_ASSERT_INTEGER_CHECK(check_mode, expected, result,
                                 __CLOVE_GENERIC_LONG, _long, _this)
}

void __clove_assert_ulong(__clove_assert_check_e check_mode,
                          unsigned long expected, unsigned long result,
                          __clove_test_t* _this)
{
    __CLOVE_ASSERT_INTEGER_CHECK(check_mode, expected, result,
                                 __CLOVE_GENERIC_ULONG, _ulong, _this)
}

void __clove_assert_llong(__clove_assert_check_e check_mode, long long expected,
                          long long result, __clove_test_t* _this)
{
    __CLOVE_ASSERT_INTEGER_CHECK(check_mode, expected, result,
                                 __CLOVE_GENERIC_LLONG, _llong, _this)
}

void __clove_assert_ullong(__clove_assert_check_e check_mode,
                           unsigned long long expected,
                           unsigned long long result, __clove_test_t* _this)
{
    __CLOVE_ASSERT_INTEGER_CHECK(check_mode, expected, result,
                                 __CLOVE_GENERIC_ULLONG, _ullong, _this)
}

void __clove_assert_sizet(__clove_assert_check_e check_mode, size_t expected,
                          size_t result, __clove_test_t* _this)
{
    __CLOVE_ASSERT_INTEGER_CHECK(check_mode, expected, result,
                                 __CLOVE_GENERIC_SIZET, _sizet, _this)
}

void __clove_assert_char(__clove_assert_check_e check_mode, char expected,
                         char result, __clove_test_t* _this)
{
    __CLOVE_ASSERT_INTEGER_CHECK(check_mode, expected, result,
                                 __CLOVE_GENERIC_CHAR, _char, _this)
}

void __clove_assert_bool(__clove_assert_check_e check_mode, bool expected,
                         bool result, __clove_test_t* _this)
{
    __CLOVE_ASSERT_INTEGER_CHECK(check_mode, expected, result,
                                 __CLOVE_GENERIC_BOOL, _bool, _this)
}

void __clove_assert_null(__clove_assert_check_e check_mode, void* expected,
                         void* result, __clove_test_t* _this)
{
    __CLOVE_ASSERT_INTEGER_CHECK(check_mode, expected, result,
                                 __CLOVE_GENERIC_PTR, _ptr, _this)
}

void __clove_assert_ptr(__clove_assert_check_e check_mode, void* expected,
                        void* result, __clove_test_t* _this)
{
    __CLOVE_ASSERT_INTEGER_CHECK(check_mode, expected, result,
                                 __CLOVE_GENERIC_PTR, _ptr, _this)
...
void __clove_assert_float(__clove_assert_check_e check_mode, float expected,
                          float result, unsigned char precision,
                          __clove_test_t* _this)
{
    bool pass_scenario = false;
    if (check_mode == __CLOVE_ASSERT_EQ)
    {
        pass_scenario =
          fabsf(expected - result) <= __clove_math_decimalf(precision);
    }
    else if (check_mode == __CLOVE_ASSERT_NE)
    {
        pass_scenario =
...
void __clove_assert_double(__clove_assert_check_e check_mode, double expected,
                           double result, unsigned char precision,
                           __clove_test_t* _this)
{
    bool pass_scenario = false;
    if (check_mode == __CLOVE_ASSERT_EQ)
    {
        pass_scenario =
          fabs(expected - result) <= __clove_math_decimald(precision);
    }
    else if (check_mode == __CLOVE_ASSERT_NE)
    {
        pass_scenario =
...
void __clove_assert_string(__clove_assert_check_e check_mode,
                           ...
                           __clove_test_t* _this)
{
    ...
    else
    {
        ...
        _this->issue.expected._string =
          __clove_string_strdup(expected); // in case is allocated on the stack
                                           // within the test function
        _this->issue.actual._string = __clove_string_strdup(
          result); // in case is allocated on the stack within the test function
    }
}
...
{
    __clove_stream_console_t* stream =
      __CLOVE_MEMORY_MALLOC_TYPE(__clove_stream_console_t);
...
void __clove_stream_console_seek(__clove_stream_t* stream, long offset,
                                 int origin)
{
    __CLOVE_UNUSED_VAR(stream);
...
__clove_stream_file_t* __clove_stream_file_new(const char* file_path)
{
    __clove_stream_file_t* stream =
      __CLOVE_MEMORY_MALLOC_TYPE(__clove_stream_file_t);
...
bool __clove_stream_file_open(__clove_stream_t* stream)
{
    ...
    _this->file = __clove_file_open(
      _this->file_path, "wb"); // binary mode so \n will stay \n (and not
                               // converted to \r\n on windows)
...
{
    __clove_stream_file_t* _this = (__clove_stream_file_t*)stream;
    fseek(_this->file, offset,
          origin); // TODO: wrap into __clove_file_seek method
}
...
{
    __clove_stream_memory_t* stream =
      __CLOVE_MEMORY_MALLOC_TYPE(__clove_stream_memory_t);
                                  ...
                                  ...)
{
    ...
    char* line = __CLOVE_MEMORY_CALLOC_TYPE_N(
      char, 1000); // TODO: Better computing real line size.
    __clove_string_vsprintf(line, 1000, format, args);
    __CLOVE_VECTOR_ADD(&((__clove_stream_memory_t*)stream)->lines, char*, line);

    va_end(args);
}
void __clove_stream_memory_seek(__clove_stream_t* stream, long offset,
                                int origin)
{
    __CLOVE_UNUSED_VAR(stream);
    __CLOVE_UNUSED_VAR(offset);
...
char* __clove_stream_memory_get_line(__clove_stream_memory_t* mem_stream,
                                     size_t index)
{
...
void __clove_test_expr_init(__clove_test_expr_t* expr, const char* expr_str)
{
    ...
    if (dot_begin)
    {
        ...
        if (suite_len == 0)
            expr->suite_view = __clove_string_view_from_str("");
        else
            expr->suite_view =
              __clove_string_view_from_be(expr_str, dot_begin - 1);
...
bool __clove_test_expr_validate_vw(const __clove_string_view_t* match,
                                   const __clove_string_view_t* view)
{
    ...
    if (start_asterisk && end_asterisk)
    {
        ...
        __clove_string_view_t fixture =
          __clove_string_view_from_be(match_start + 1, match_end - 1);
    ...
    if (end_asterisk)
    {
        return __clove_string_view_ncmp(match, view,
                                        __clove_string_view_length(match) - 1);
    }
    return __clove_string_view_equals(match, view);
}

bool __clove_test_expr_validate(__clove_test_expr_t* expr,
                                const __clove_string_view_t* suite,
                                const __clove_string_view_t* test)
{
    if (!__clove_test_expr_validate_vw(&(expr->suite_view), suite))
        return false;
...
__clove_report_run_tests_pretty_new(__clove_stream_t* stream,
                                    __clove_report_params_t* params)
{
    __clove_report_pretty_t* result =
      __CLOVE_MEMORY_MALLOC_TYPE(__clove_report_pretty_t);
...
void __clove_report_pretty_start(__clove_report_t* _this,
                                 __clove_vector_t* suites, size_t test_count)
{
    __clove_report_pretty_t* report = (__clove_report_pretty_t*)_this;
    report->start_time = __clove_time_now();
    report->max_test_digits =
      (unsigned int)snprintf(NULL, 0U, "%zu", test_count);
    ...
    if (report->params->report_detail ==
        __CLOVE_REPORT_DETAIL__PASSED_FAILED_SKIPPED)
    {
        level_str = "Full";
    }
    ...
    else if (report->params->report_detail ==
             __CLOVE_REPORT_DETAIL__FAILED_SKIPPED)
    {
    ...
    if (longest_suite_and_test_name < 46)
        longest_suite_and_test_name = 46; // rounded to 50 by next operation
    ...
    // max len capping
    if (report->max_suite_and_test_name_size > __CLOVE_STRING_LENGTH)
        report->max_suite_and_test_name_size = __CLOVE_STRING_LENGTH;

    size_t suite_count = __clove_vector_count(suites);

    report->stream->open(report->stream);
    report->stream->writef(report->stream,
                           "%s Executing Test Runner with detail level: '%s'\n",
                           report->labels.info, level_str);
    report->stream->writef(report->stream,
                           "%s Suites / Tests found: %zu / %zu\n",
                           report->labels.info, suite_count, test_count);
}
void __clove_report_pretty_begin_suite(__clove_report_t* _this,
                                       __clove_suite_t* suite, size_t index)
{
    __CLOVE_UNUSED_VAR(_this);
...
void __clove_report_pretty_end_suite(__clove_report_t* _this,
                                     __clove_suite_t* suite, size_t index)
{
    __CLOVE_UNUSED_VAR(_this);
    __CLOVE_UNUSED_VAR(suite);
...
void __clove_report_pretty_end(__clove_report_t* _this, size_t passed,
                               size_t skipped, size_t failed)
{
    __clove_report_pretty_t* report = (__clove_report_pretty_t*)_this;
    ...
    report->stream->writef(
      report->stream, "%s Total: %zu, Passed: %zu, Failed: %zu, Skipped: %zu\n",
    ...
    if (passed == report->test_count)
    {
        report->stream->writef(report->stream, "%s Run result: SUCCESS :-)\n",
                               report->labels.info);
    }
    else if (failed > 0)
    {
        report->stream->writef(report->stream, "%s Run result: FAILURE :_(\n",
                               report->labels.erro);
    }
    else if (skipped > 0)
    {
        report->stream->writef(
          report->stream,
          "%s Run result: OK, but some test has been skipped!\n",
          report->labels.warn);
    }
...
void __clove_report_pretty_end_test(__clove_report_t* _this,
                                    __clove_suite_t* suite,
                                    __clove_test_t* test, size_t test_number)
{
    __clove_report_pretty_t* report = (__clove_report_pretty_t*)_this;
    ...
    __clove_string_sprintf(test_identifier, __CLOVE_STRING_LENGTH, "%s.%s",
                           suite->name, test->name);
    __clove_string_pad_right(test_identifier, __CLOVE_STRING_LENGTH,
                             report->max_suite_and_test_name_size);

    if (print_passed && test->result == __CLOVE_TEST_RESULT_PASSED)
    {
        float millis = (float)(__clove_time_to_nanos(&(test->duration))) /
                       (float)__CLOVE_TIME_TRANSL_NANOS_PER_MILLIS;
        int decimal = millis > 1.f ? 0 : 3;

        report->stream->writef(report->stream, "%s %0*zu) %s%s (%.*f ms)\n",
                               report->labels.info, report->max_test_digits,
                               test_number, test_identifier,
                               report->labels.pass, decimal, millis);
    }
    else if (print_failed && test->result == __CLOVE_TEST_RESULT_FAILED)
    {
        ...
        {
            __clove_string_sprintf(msg, sizeof(msg), "%s",
                                   "A FAIL assertion was met!");
        }
        else
        {
            ...
            __CLOVE_SWITCH_CASE(__CLOVE_GENERIC_BOOL)
            {
                ...
                //__clove_string_sprintf(msg, sizeof(msg), "expected [%s] but
                // was [%s]", exp, act);
                __PRETTY_PRINT_FAIL_ASSERT_MSG(
                  msg, sizeof(msg), test->issue.assert, exp, act, "%s");
            }
            __CLOVE_SWITCH_CASE(__CLOVE_GENERIC_CHAR)
            {
                // const char* non = test->issue.assert == __CLOVE_ASSERT_EQ ?
                // "" : "not ";
                const char exp = test->issue.expected._char;
                const char act = test->issue.actual._char;
                //__clove_string_sprintf(msg, sizeof(msg), "%sexpected [%c] but
                // was [%c]", non, exp, act);
                __PRETTY_PRINT_FAIL_ASSERT_MSG(
                  msg, sizeof(msg), test->issue.assert, exp, act, "%c");
            }
            __CLOVE_SWITCH_CASE(__CLOVE_GENERIC_INT)
            {
                ...
                //__clove_string_sprintf(msg, sizeof(msg), "%sexpected [%d] but
                // was [%d]", non, exp, act);
                __PRETTY_PRINT_FAIL_ASSERT_MSG(
                  msg, sizeof(msg), test->issue.assert, exp, act, "%d");
            }
            __CLOVE_SWITCH_CASE(__CLOVE_GENERIC_UINT)
            {
                ...
                //__clove_string_sprintf(msg, sizeof(msg), "%sexpected [%u] but
                // was [%u]", non, exp, act);
                __PRETTY_PRINT_FAIL_ASSERT_MSG(
                  msg, sizeof(msg), test->issue.assert, exp, act, "%u");
            }
            __CLOVE_SWITCH_CASE(__CLOVE_GENERIC_LONG)
            {
                ...
                //__clove_string_sprintf(msg, sizeof(msg), "%sexpected [%ld] but
                // was [%ld]", non, exp, act);
                __PRETTY_PRINT_FAIL_ASSERT_MSG(
                  msg, sizeof(msg), test->issue.assert, exp, act, "%ld");
            }
            __CLOVE_SWITCH_CASE(__CLOVE_GENERIC_ULONG)
            {
                ...
                //__clove_string_sprintf(msg, sizeof(msg), "%sexpected [%lu] but
                // was [%lu]", non, exp, act);
                __PRETTY_PRINT_FAIL_ASSERT_MSG(
                  msg, sizeof(msg), test->issue.assert, exp, act, "%lu");
            }
            __CLOVE_SWITCH_CASE(__CLOVE_GENERIC_LLONG)
            {
                ...
                //__clove_string_sprintf(msg, sizeof(msg), "%sexpected [%lld]
                // but was [%lld]", non, exp, act);
                __PRETTY_PRINT_FAIL_ASSERT_MSG(
                  msg, sizeof(msg), test->issue.assert, exp, act, "%lld");
            }
            __CLOVE_SWITCH_CASE(__CLOVE_GENERIC_ULLONG)
            {
                ...
                //__clove_string_sprintf(msg, sizeof(msg), "%sexpected [%llu]
                // but was [%llu]", non, exp, act);
                __PRETTY_PRINT_FAIL_ASSERT_MSG(
                  msg, sizeof(msg), test->issue.assert, exp, act, "%llu");
            }
            __CLOVE_SWITCH_CASE(__CLOVE_GENERIC_SIZET)
            {
                ...
                //__clove_string_sprintf(msg, sizeof(msg), "%sexpected [%zu] but
                // was [%zu]", non, exp, act);
                __PRETTY_PRINT_FAIL_ASSERT_MSG(
                  msg, sizeof(msg), test->issue.assert, exp, act, "%zu");
            }
            __CLOVE_SWITCH_CASE(__CLOVE_GENERIC_FLOAT)
            {
                ...
                __clove_string_sprintf(format, sizeof(format), "%%.%df",
                                       test->issue.floating_precision);
                __PRETTY_PRINT_FAIL_ASSERT_MSG(
                  msg, sizeof(msg), test->issue.assert, exp, act, format);
            }
            ...
            {
                const char* non =
                  test->issue.assert == __CLOVE_ASSERT_EQ ? "" : "not ";
                ...
                if (exp_len <= max_len && act_len <= max_len)
                {
                    ...
                    __clove_string_sprintf(msg, sizeof(msg),
                                           "%sexpected \"%s\" but was \"%s\"",
                                           non, exp_escaped, act_escaped);
            ...
            __CLOVE_SWITCH_CASE(__CLOVE_GENERIC_PTR)
            {
                ...
                //__clove_string_sprintf(msg, sizeof(msg), "%sexpected [%p] but
                // was [%p]", non, exp, act);
                __PRETTY_PRINT_FAIL_ASSERT_MSG(
                  msg, sizeof(msg), test->issue.assert, exp, act, "%p");
            }
            __CLOVE_SWITCH_END()
        }
        ...
        {
            file_path = __clove_path_relative(test->file_name,
                                              report->params->tests_base_path);
        }

        report->stream->writef(
          report->stream, "%s %0*zu) %s%s %s:%zu: %s\n", report->labels.erro,
          report->max_test_digits, test_number, test_identifier,
          report->labels.fail, file_path, test->issue.line, msg);
    }
    else if (print_skipped && test->result == __CLOVE_TEST_RESULT_SKIPPED)
    {
        ...
        report->stream->writef(report->stream, "%s %0*zu) %s%s %s:%zu: %s\n",
                               report->labels.warn, report->max_test_digits,
                               test_number, test_identifier,
                               report->labels.skip, file_path, test->funct_line,
                               "Missing assertion!");
    }
}

void __clove_report_pretty_string_ellipse(const char* exp, size_t exp_len,
                                          const char* act, size_t act_len,
                                          char* exp_short, char* act_short,
                                          size_t short_size)
{
    ...
    // Scenario where the shortest one is the like the "prefix" of the longest
    // one
...
__clove_report_run_tests_csv_new(__clove_stream_t* stream,
                                 __clove_report_params_t* params)
{
    __clove_report_run_tests_csv_t* result =
      __CLOVE_MEMORY_MALLOC_TYPE(__clove_report_run_tests_csv_t);
...
void __clove_report_run_tests_csv_start(__clove_report_t* _this,
                                        __clove_vector_t* suites,
                                        size_t test_count)
{
    __CLOVE_UNUSED_VAR(_this);
    ...
    __clove_report_run_tests_csv_t* report =
      (__clove_report_run_tests_csv_t*)_this;
    report->stream->open(report->stream);
    report->stream->writef(report->stream, "%s,%s,%s,%s,%s,%s,%s,%s,%s,%s\n",
                           "Suite", "Test", "Status", "Duration", "File",
                           "Line", "Assert", "Type", "Expected", "Actual");
}
void __clove_report_run_tests_csv_begin_suite(__clove_report_t* _this,
                                              __clove_suite_t* suite,
                                              size_t index)
{
    __CLOVE_UNUSED_VAR(_this);
...
void __clove_report_run_tests_csv_end_suite(__clove_report_t* _this,
                                            __clove_suite_t* suite,
                                            size_t index)
{
    __CLOVE_UNUSED_VAR(_this);
...
void __clove_report_run_tests_csv_end(__clove_report_t* _this, size_t passed,
                                      size_t skipped, size_t failed)
{
...
void __clove_report_run_tests_csv_end_test(__clove_report_t* _this,
                                           __clove_suite_t* suite,
                                           __clove_test_t* test,
                                           size_t test_number)
{
    ...
    {
        report->stream->writef(
          report->stream, "%s,%s,%s,%llu,%s,%s,%s,%s,%s,%s\n", suite->name,
          test->name, test->result, __clove_time_to_nanos(&(test->duration)),
          "", "", "", "", "", "");
    }
    else if (print_failed && test->result == __CLOVE_TEST_RESULT_FAILED)
    {
        const char* data_type = (test->issue.assert == __CLOVE_ASSERT_FAIL)
                                  ? ""
                                  : test->issue.data_type;
        const char* file_name = __clove_path_relative(
          test->file_name, report->params->tests_base_path);

        report->stream->writef(report->stream, "%s,%s,%s,%s,%s,%zu,%s,%s,",
                               suite->name, test->name, test->result, "",
                               file_name, test->issue.line, test->issue.assert,
                               data_type);

        __clove_report_run_tests_csv_print_data(report, test,
                                                &test->issue.expected);
        report->stream->writef(report->stream, ",");
        __clove_report_run_tests_csv_print_data(report, test,
                                                &test->issue.actual);
    ...
    else if (print_skipped && test->result == __CLOVE_TEST_RESULT_SKIPPED)
    {
        ...
        report->stream->writef(report->stream,
                               "%s,%s,%s,%s,%s,%zu,%s,%s,%s,%s\n", suite->name,
                               test->name, test->result, "", file_name,
                               test->funct_line, "", "", "", "");
    }
}

void __clove_report_run_tests_csv_print_data(
  __clove_report_run_tests_csv_t* instance, __clove_test_t* test,
  __clove_generic_u* data)
{
    if (test->issue.assert == __CLOVE_ASSERT_FAIL)
    {
    ...
    else
    {
        ...
        __CLOVE_SWITCH_CASE(__CLOVE_GENERIC_FLOAT)
        instance->stream->writef(instance->stream, "%.*f",
                                 test->issue.floating_precision, data->_float);
        __CLOVE_SWITCH_CASE(__CLOVE_GENERIC_DOUBLE)
        instance->stream->writef(instance->stream, "%.*f",
                                 test->issue.floating_precision, data->_double);
        __CLOVE_SWITCH_CASE(__CLOVE_GENERIC_STRING)
        {
...
__clove_report_run_tests_json_new(__clove_stream_t* stream,
                                  __clove_report_params_t* params)
{
    __clove_report_json_t* result =
      __CLOVE_MEMORY_MALLOC_TYPE(__clove_report_json_t);
    ...
    // Full report is the main usage scenario, so a report will be computed
    // during test execution, instead, for detail Failed (or Failed+Skipped)
    // need it to cache suites (and related test) and only compute the report at
    // end of tests executions
    result->is_realtime_scenario =
...
void __clove_report_json_start(__clove_report_t* _this,
                               __clove_vector_t* suites, size_t test_count)
{
    __CLOVE_UNUSED_VAR(suites);
    ...
    {
        __CLOVE_VECTOR_INIT_CAPACITY(&instance->cached_suites, __clove_suite_t*,
    ...
    if (!opened)
    {
        __clove_console_printf("ERROR OPENING STREAM\n");
...
void __clove_report_json_end(__clove_report_t* _this, size_t passed,
                             size_t skipped, size_t failed)
{
    __clove_report_json_t* instance = (__clove_report_json_t*)_this;
    ...
    if (!instance->is_reporting_enabled)
    {
        ...
        else if (instance->params->report_detail ==
                 __CLOVE_REPORT_DETAIL__FAILED_SKIPPED)
        {
            report_failed = true;
            report_skipped = true;
        ...
        {
            __clove_suite_t* suite = *(__clove_suite_t**)__clove_vector_get(
              &instance->cached_suites, suite_index);
            ...
            if (has_failed)
                instance->suite_tests_number += suite->issue.failed_count;
            if (has_skipped)
                instance->suite_tests_number += suite->issue.skipped_count;

            __clove_report_json_begin_suite(_this, suite, suite_index);

            for (size_t test_index = 0;
                 test_index < __clove_vector_count(&suite->tests); ++test_index)
            {
                __clove_test_t* test = (__clove_test_t*)__clove_vector_get(
                  &suite->tests, test_index);
                bool failed_case =
                  report_failed && test->result == __CLOVE_TEST_RESULT_FAILED;
                bool skipped_case =
                  report_skipped && test->result == __CLOVE_TEST_RESULT_SKIPPED;
    ...
    if (passed == instance->test_count)
        status = __CLOVE_TEST_RESULT_PASSED;
    else if (failed > 0)
        status = __CLOVE_TEST_RESULT_FAILED;
    else if (skipped > 0)
        status = __CLOVE_TEST_RESULT_SKIPPED;
...
void __clove_report_json_print_data(__clove_report_json_t* instance,
                                    __clove_test_t* test,
                                    __clove_generic_u* data)
{
    if (test->issue.assert == __CLOVE_ASSERT_FAIL)
...
void __clove_report_json_begin_suite(__clove_report_t* _this,
                                     __clove_suite_t* suite, size_t index)
{
    __CLOVE_UNUSED_VAR(index);
...
void __clove_report_json_end_suite(__clove_report_t* _this,
                                   __clove_suite_t* suite, size_t index)
{
    __CLOVE_UNUSED_VAR(index);
...
void __clove_report_json_end_test(__clove_report_t* _this,
                                  __clove_suite_t* suite, __clove_test_t* test,
                                  size_t test_number)
{
    __CLOVE_UNUSED_VAR(test_number);
    ...
    {
        const char* file_path = __clove_path_relative(
          test->file_name, instance->params->tests_base_path);
    ...
    instance->stream->writef(instance->stream, "\t\t\t\t\t\"%s\" : {\n",
                             test->name);
    instance->stream->writef(
      instance->stream, "\t\t\t\t\t\t\"status\" : \"%s\",\n", test->result);
    instance->stream->writef(instance->stream,
                             "\t\t\t\t\t\t\"duration\" : %llu",
                             __clove_time_to_nanos(&(test->duration)));
    if (test->result == __CLOVE_TEST_RESULT_FAILED)
    {
        instance->stream->writef(instance->stream, ",\n");
        instance->stream->writef(
          instance->stream, "\t\t\t\t\t\t\"line\" : %zu,\n", test->issue.line);
        instance->stream->writef(instance->stream,
                                 "\t\t\t\t\t\t\"assert\" : \"%s\"",
                                 test->issue.assert);
        if (test->issue.assert != __CLOVE_ASSERT_FAIL)
        {
            ...
            instance->stream->writef(instance->stream,
                                     "\t\t\t\t\t\t\"expected\" : \"");
            __clove_report_json_print_data(instance, test,
                                           &(test->issue.expected));
            instance->stream->writef(instance->stream, "\",\n");
    ...
    if (!instance->is_realtime_scenario)
        suite_total_tests = instance->suite_tests_number;
...
__clove_report_list_tests_pretty_new(__clove_stream_t* stream,
                                     __clove_report_params_t* params)
{
    __clove_report_list_tests_pretty_t* _this =
      __CLOVE_MEMORY_MALLOC_TYPE(__clove_report_list_tests_pretty_t);
...
void __clove_report_list_tests_pretty_begin(__clove_report_list_tests_t* _this,
                                            ...
                                            size_t test_count)
{
    __clove_report_list_tests_pretty_t* pretty =
      (__clove_report_list_tests_pretty_t*)_this;
    ...
    if (activated)
    {
        ...
        pretty->stream->writef(pretty->stream,
                               "\nListing \x1b[1;32m%zu\x1b[0m Test(s) in "
                               "\x1b[1;34m%zu\x1b[0m Suite(s):\n\n",
  ...
  __clove_report_list_tests_t* _this, __clove_test_t* test, size_t index)
{
    ...
    {
        const char* file_path = __clove_path_relative(
          test->file_name, pretty->params->tests_base_path);
        pretty->stream->writef(pretty->stream, pretty->suite_format,
                               pretty->current_suite->name, file_path);
        pretty->is_suite_first_test = false;
    }
    pretty->stream->writef(pretty->stream, pretty->test_format, test->name,
                           test->funct_line);
}
void __clove_report_list_tests_pretty_end(__clove_report_list_tests_t* _this)
{
...
__clove_report_list_tests_csv_new(__clove_stream_t* stream,
                                  __clove_report_params_t* params)
{
    __clove_report_list_tests_csv_t* _this =
      __CLOVE_MEMORY_MALLOC_TYPE(__clove_report_list_tests_csv_t);
                                         ...
                                         size_t suite_count, size_t test_count)
{
    ...
    __clove_report_list_tests_csv_t* csv =
      (__clove_report_list_tests_csv_t*)_this;
                                            ...
                                            __clove_test_t* test, size_t index)
{
    ...
    __clove_report_list_tests_csv_t* csv =
      (__clove_report_list_tests_csv_t*)_this;
    const char* file_path =
      __clove_path_relative(test->file_name, csv->params->tests_base_path);
    csv->stream->writef(csv->stream, "%s,%s,%s,%zu\n", csv->current_suite->name,
                        test->name, file_path, test->funct_line);
}
void __clove_report_list_tests_csv_end(__clove_report_list_tests_t* _this)
{
    __clove_report_list_tests_csv_t* csv =
...
__clove_report_list_tests_json_new(__clove_stream_t* stream,
                                   __clove_report_params_t* params)
{
    __clove_report_list_tests_json_t* _this =
      __CLOVE_MEMORY_MALLOC_TYPE(__clove_report_list_tests_json_t);
...
void __clove_report_list_tests_json_begin(__clove_report_list_tests_t* _this,
                                          size_t suite_count, size_t test_count)
{
    __clove_report_list_tests_json_t* json =
      (__clove_report_list_tests_json_t*)_this;
                                             ...
                                             __clove_test_t* test, size_t index)
{
    ...
    {
        const char* file_path =
          __clove_path_relative(test->file_name, json->params->tests_base_path);
        char* escaped_file = __clove_string_strdup(file_path);
        __clove_string_replace_char(escaped_file, '\\', '/');
                                  ...
                                  __clove_report_list_tests_t* report)
{
    ...
    for (size_t i = 0; i < suite_count; ++i)
    {
        ...
        {
            __clove_test_t* each_test =
              (__clove_test_t*)__clove_vector_get(&each_suite->tests, j);
...
bool __clove_symbols_function_validate(__clove_string_view_t* suite,
                                       __clove_string_view_t* type,
                                       __clove_string_view_t* name,
                                       __clove_symbols_context_t* context)
{
    if (__clove_vector_is_empty(context->includes) &&
        __clove_vector_is_empty(context->excludes))
        return true;
    ...
    if (!__clove_vector_is_empty(context->includes))
    {
        ...
        {
            __clove_test_expr_t* expr =
              (__clove_test_expr_t*)__clove_vector_get(context->includes, i);
    ...
    if (!__clove_vector_is_empty(context->excludes))
    {
        ...
        {
            __clove_test_expr_t* expr =
              (__clove_test_expr_t*)__clove_vector_get(context->excludes, i);
...
void __clove_symbols_function_collect(__clove_symbols_function_t exported_funct,
                                      __clove_symbols_context_t* context)
{
    /* Examples
    ...
    */
    ...
    static __clove_suite_t
      last_suite_temp; // just used as temporary data storage
    ...
    const char* end_suite_name =
      __clove_string_strstr(begin_suite_name, end_suite_separator) - 1;

    __clove_string_view_t suite_vw =
      __clove_string_view_from_be(begin_suite_name, end_suite_name);
    __clove_string_view_t type_vw = __clove_string_view_from_len(
      end_suite_name + 1 + end_suite_separator_length, 2);
    __clove_string_view_t name_vw =
      __clove_string_view_from_str(__clove_string_view_end(&type_vw) + 2);

    bool pass =
      __clove_symbols_function_validate(&suite_vw, &type_vw, &name_vw, context);
    if (!pass) return;

    // if suite changes, then start collecting temporary suite data, waiting for
    // a first test to be found
    if (suite_name_view.begin == NULL ||
        !__clove_string_view_equals(&suite_vw, &suite_name_view))
    {
    ...
    else if (__clove_string_view_strequals(&type_vw, "20"))
    {
        ...
        {
            last_suite_temp.test_count =
              1; // just to record that at least one test case has been found

            last_suite_ptr =
              (__clove_suite_t*)__clove_vector_add_slot(&context->suites);
            last_suite_ptr->name =
              __clove_string_view_as_string(&suite_name_view);
            if (last_suite_temp.fixtures.setup_once)
                last_suite_ptr->fixtures.setup_once =
                  last_suite_temp.fixtures.setup_once;
            if (last_suite_temp.fixtures.teardown_once)
                last_suite_ptr->fixtures.teardown_once =
                  last_suite_temp.fixtures.teardown_once;
            if (last_suite_temp.fixtures.setup)
                last_suite_ptr->fixtures.setup = last_suite_temp.fixtures.setup;
            if (last_suite_temp.fixtures.teardown)
                last_suite_ptr->fixtures.teardown =
                  last_suite_temp.fixtures.teardown;
            context->suites_count++;
        }

        __clove_test_t* test =
          (__clove_test_t*)__clove_vector_add_slot(&last_suite_ptr->tests);
        // Switched to string allocation to make test structs independent of the
        // source memory test->name = test_name + test_separator_length;
...
__clove_symbols_win_get_export_table_from(HMODULE module)
{
...
int __clove_symbols_for_each_function_by_prefix(
  __clove_symbols_context_t* context, __clove_symbols_function_action action)
{
    HMODULE module = GetModuleHandle(0);
    PIMAGE_EXPORT_DIRECTORY export_dir =
      __clove_symbols_win_get_export_table_from(module);
    if (!export_dir)
    {
        return 1;
    }

    // Note: Don't know why if there is no exported function results
    // NumberOfNames = 64. NumberOfFunctions = 0 instead.
    //       So checking both counters to be sure if there is any exported
    //       function
    ...
    PWORD ordinals_ptr =
      (PWORD)(base_addr +
              export_dir
                ->AddressOfNameOrdinals); // ordinal offset from base ordinal
    PDWORD functs_address_ptr =
      (PDWORD)(base_addr + export_dir->AddressOfFunctions);
    ...
    // And also that prefix starting with "__" will come first. So no need to
    ...
    for (size_t i = 0; i < export_dir->NumberOfNames; ++i)
    {
        ...
        unsigned long* each_funct_addr =
          (PDWORD)(base_addr +
                   functs_address_ptr[each_ordinal - ordinal_base_number]);
        ...
        {
            // At the first failure, if match was ongoing then there are no more
            // symbol with that prefix
...
bool __clove_symbols_macos_image_slide(const char* abs_path,
                                       intptr_t* out_address)
{
    // NOTE: dyld image names are in absolute path. So tu properly compare, need
    // to pass an abs_path to this function.
...
int __clove_symbols_macos_open_module_handle(
  const char* module_abs_path, __clove_symbols_macos_module_t* out_module)
{
    int fd;
    ...
    bool found =
      __clove_symbols_macos_image_slide(module_abs_path, &out_module->address);
    if (!found)
    {
...
void __clove_symbols_macos_close_module_handle(
...
struct load_command*
__clove_symbols_macos_find_command(struct mach_header_64* header, uint32_t cmd)
{
    struct load_command* lc =
      (struct load_command*)((uint64_t)header + sizeof(struct mach_header_64));
  ...
  __clove_symbols_context_t* context, __clove_symbols_function_action action)
{
    ...
    __clove_symbols_macos_module_t module;
    if (__clove_symbols_macos_open_module_handle(module_path, &module) != 0)
    {
        return 1;
    };

    // Handling Mach-o file format x86_64 (little endian). This should works
    // both for Intel and M1 cpus with 64 bits architecture
    uint32_t magic_number = *(uint32_t*)module.handle;
    if (magic_number != MH_MAGIC_64)
    {
        puts("Current executable format is not supported (it's not Mach-o "
             "64bit little-endian!");
        return 2;
    }

    struct mach_header_64* header = (struct mach_header_64*)module.handle;
    struct load_command* symbol_lc =
      __clove_symbols_macos_find_command(header, LC_SYMTAB);
    struct symtab_command* symbol_cmd = (struct symtab_command*)symbol_lc;

    struct nlist_64* symbol_table_64 =
      (struct nlist_64*)((uint64_t)header + symbol_cmd->symoff);
    char* str_table = (char*)header + symbol_cmd->stroff;
    // symbol_cmd->nsyms #number of symbols in the symbol table

    // Loading Dynamic Symbol table to scan only for external symbols symbols in
    // the Symbol Table
    struct load_command* dynsymbol_lc =
      __clove_symbols_macos_find_command(header, LC_DYSYMTAB);
    struct dysymtab_command* dysymbol_cmd =
      (struct dysymtab_command*)dynsymbol_lc;
    uint32_t external_symbol_start_index = dysymbol_cmd->iextdefsym;
    uint32_t external_symbol_end_index =
      external_symbol_start_index + dysymbol_cmd->nextdefsym - 1U;

    const char* prefix = context->prefix;
    const size_t prefix_length = context->prefix_length;
    uint8_t match_ongoing = 0;
    for (uint32_t i = external_symbol_start_index;
         i <= external_symbol_end_index; i++)
    {
        struct nlist_64* sym = &symbol_table_64[i];
        uint32_t table_index = sym->n_un.n_strx;
        char* each_name =
          &str_table[table_index + 1]; // macho add one '_' before each symbol,
                                       // so with +1 we want to skip it.
        void* each_funct_addr =
          (void*)(sym->n_value +
                  module
                    .address); // n_value = offset address within TEXT segment
                               // (includes base addr of the TEXT segment)

        // Symbols seems to be "locally" sorted, so all clove external functions
        // seems to be next to each other and sorted
        if (strncmp(prefix, each_name, prefix_length) == 0)
        {
            if (!match_ongoing)
            {
...
int __clove_symbols_lixux_dl_callback(struct dl_phdr_info* info, size_t size,
                                      void* data)
{
...
#endif
    // Preventing GCC pedantic from emitting warning: "ISO C forbids conversion
    ...
    for (int j = 0; j < info->dlpi_phnum; j++)
    {
        ...
        if (phdr->p_type == PT_LOAD)
        {
            ...
            if (beg <= cb && cb < end)
            {
                ...
                // printf("ELF header is at %p, image linked at 0x%zx,
                // relocation: 0x%zx\n", base + first_load->p_vaddr,
                // first_load->p_vaddr, info->dlpi_addr);
...
int __clove_symbols_lixux_open_module_handle(
  const char* module_path, __clove_symbols_lixux_module_t* out_module)
{
    int fd;
...
void __clove_symbols_lixux_close_module_handle(
  ...
  __clove_symbols_context_t* context, __clove_symbols_function_action action)
{
    ...
    __clove_symbols_lixux_module_t module;
    if (__clove_symbols_lixux_open_module_handle(module_path, &module) != 0)
    {
        return 1;
    }
    ...
    bool is_elf = (magic[0] == 0x7f && magic[1] == 0x45 && magic[2] == 0x4c &&
                   magic[3] == 0x46);
    ...
    {
        puts("Current executable format is not supported (it's not ELF 64bit "
             "little-endian!)");
        return 2;
    }
    ...
    for (size_t i = 0; i < section_count; ++i)
    {
        ...
        {
            symbol_table =
              (Elf64_Sym*)((uint64_t)header + sections[i].sh_offset);
    ...
    char* symbol_name_table =
      (char*)((uint64_t)header + name_table_section->sh_offset);

    size_t symbol_count =
      symbol_table_section->sh_size / symbol_table_section->sh_entsize;

    // Vector could be replaced with a sorted tree to sort while scanning for
    // clove functions
    __clove_vector_t clove_functions;
    __clove_vector_params_t params =
      __clove_vector_params_defaulted(sizeof(__clove_symbols_function_t));
    ...
    for (size_t i = 0; i < symbol_count; ++i)
    {
        ...
        if (ELF64_ST_TYPE(sym->st_info) == STT_FUNC)
        {
            ...
            {
                __clove_symbols_function_t* each_funct =
                  (__clove_symbols_function_t*)__clove_vector_add_slot(
                    &clove_functions);
    ...
    __clove_vector_sort(&clove_functions,
                        __clove_symbols_funct_name_comparator);

    for (size_t i = 0; i < __clove_vector_count(&clove_functions); ++i)
    {
        __clove_symbols_function_t* each_funct =
          (__clove_symbols_function_t*)__clove_vector_get(&clove_functions, i);
...
#define __CLOVE_RUNNER_AUTO()                                                  \
    ...
    int main(int argc, char* argv[]) { return __clove_runner_auto(argc, argv); }
...
int __clove_runner_auto(int argc, char* argv[])
{
    ...
    // argc = 5;
    // const char* argv2[] = {"exec", "-i", "*.ActShortThanExpForthCharDiff",
    // "-r", "pretty"}; const char* argv2[] = {"exec", "-l", "-r", "csv"};

    __clove_vector_t cmd_handlers;
    __CLOVE_VECTOR_INIT(&cmd_handlers, __clove_cmdline_handler_f);
    __CLOVE_VECTOR_ADD(&cmd_handlers, __clove_cmdline_handler_f,
                                  ...
                                  __clove_vector_t* excludes)
{
    ...
    if (result == 0)
    {
        ...
        run_result =
          __clove_exec_suites(&context.suites, context.tests_count, report);
...
int __clove_exec_suites(__clove_vector_t* suites, size_t test_count,
                        __clove_report_t* report)
{
    ...
    __CLOVE_VECTOR_FOR(suites, __clove_suite_t, each_suite, i, {
        report->begin_suite(report, each_suite, i);
        __clove_exec_suite(each_suite, test_start_counter, &passed, &failed,
                           &skipped, report);
        report->end_suite(report, each_suite, i);
...
void __clove_exec_suite(__clove_suite_t* suite, size_t test_counter,
                        ...
                        __clove_report_t* report)
{
    ...
    {
        __clove_test_t* each_test =
          (__clove_test_t*)__clove_vector_get(&suite->tests, i);
        ...
        __CLOVE_SWITCH_CASE(__CLOVE_TEST_RESULT_PASSED)
        {
            (*passed)++;
            suite->issue.passed_count++;
        }
        __CLOVE_SWITCH_CASE(__CLOVE_TEST_RESULT_FAILED)
        {
            (*failed)++;
            suite->issue.failed_count++;
        }
        __CLOVE_SWITCH_CASE(__CLOVE_TEST_RESULT_SKIPPED)
        {
            (*skipped)++;
            suite->issue.skipped_count++;
        }
        __CLOVE_SWITCH_END()
...
#define CLOVE_FAIL()                                                           \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_fail(_this);                       \
    } while (0)
#define CLOVE_PASS()                                                           \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_pass(_this);                       \
    } while (0)

#define CLOVE_IS_TRUE(res)                                                     \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_bool(__CLOVE_ASSERT_EQ, true, res, \
                                                 _this);                       \
    } while (0)
#define CLOVE_IS_FALSE(res)                                                    \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_bool(__CLOVE_ASSERT_EQ, false,     \
                                                 res, _this);                  \
    } while (0)
...
#define CLOVE_CHAR_EQ(exp, res)                                                \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_char(__CLOVE_ASSERT_EQ, exp, res,  \
                                                 _this);                       \
    } while (0)
#define CLOVE_CHAR_NE(exp, res)                                                \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_char(__CLOVE_ASSERT_NE, exp, res,  \
                                                 _this);                       \
    } while (0)
#define CLOVE_CHAR_GT(exp, res)                                                \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_char(__CLOVE_ASSERT_GT, exp, res,  \
                                                 _this);                       \
    } while (0)
#define CLOVE_CHAR_GTE(exp, res)                                               \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_char(__CLOVE_ASSERT_GTE, exp, res, \
                                                 _this);                       \
    } while (0)
#define CLOVE_CHAR_LT(exp, res)                                                \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_char(__CLOVE_ASSERT_LT, exp, res,  \
                                                 _this);                       \
    } while (0)
#define CLOVE_CHAR_LTE(exp, res)                                               \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_char(__CLOVE_ASSERT_LTE, exp, res, \
                                                 _this);                       \
    } while (0)
...
#define CLOVE_INT_EQ(exp, res)                                                 \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_int(__CLOVE_ASSERT_EQ, exp, res,   \
                                                _this);                        \
    } while (0)
#define CLOVE_INT_NE(exp, res)                                                 \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_int(__CLOVE_ASSERT_NE, exp, res,   \
                                                _this);                        \
    } while (0)
#define CLOVE_INT_GT(exp, res)                                                 \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_int(__CLOVE_ASSERT_GT, exp, res,   \
                                                _this);                        \
    } while (0)
#define CLOVE_INT_GTE(exp, res)                                                \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_int(__CLOVE_ASSERT_GTE, exp, res,  \
                                                _this);                        \
    } while (0)
#define CLOVE_INT_LT(exp, res)                                                 \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_int(__CLOVE_ASSERT_LT, exp, res,   \
                                                _this);                        \
    } while (0)
#define CLOVE_INT_LTE(exp, res)                                                \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_int(__CLOVE_ASSERT_LTE, exp, res,  \
                                                _this);                        \
    } while (0)
...
#define CLOVE_UINT_EQ(exp, res)                                                \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_uint(__CLOVE_ASSERT_EQ, exp, res,  \
                                                 _this);                       \
    } while (0)
#define CLOVE_UINT_NE(exp, res)                                                \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_uint(__CLOVE_ASSERT_NE, exp, res,  \
                                                 _this);                       \
    } while (0)
#define CLOVE_UINT_GT(exp, res)                                                \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_uint(__CLOVE_ASSERT_GT, exp, res,  \
                                                 _this);                       \
    } while (0)
#define CLOVE_UINT_GTE(exp, res)                                               \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_uint(__CLOVE_ASSERT_GTE, exp, res, \
                                                 _this);                       \
    } while (0)
#define CLOVE_UINT_LT(exp, res)                                                \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_uint(__CLOVE_ASSERT_LT, exp, res,  \
                                                 _this);                       \
    } while (0)
#define CLOVE_UINT_LTE(exp, res)                                               \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_uint(__CLOVE_ASSERT_LTE, exp, res, \
                                                 _this);                       \
    } while (0)
...
#define CLOVE_LONG_EQ(exp, res)                                                \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_long(__CLOVE_ASSERT_EQ, exp, res,  \
                                                 _this);                       \
    } while (0)
#define CLOVE_LONG_NE(exp, res)                                                \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_long(__CLOVE_ASSERT_NE, exp, res,  \
                                                 _this);                       \
    } while (0)
#define CLOVE_LONG_GT(exp, res)                                                \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_long(__CLOVE_ASSERT_GT, exp, res,  \
                                                 _this);                       \
    } while (0)
#define CLOVE_LONG_GTE(exp, res)                                               \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_long(__CLOVE_ASSERT_GTE, exp, res, \
                                                 _this);                       \
    } while (0)
#define CLOVE_LONG_LT(exp, res)                                                \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_long(__CLOVE_ASSERT_LT, exp, res,  \
                                                 _this);                       \
    } while (0)
#define CLOVE_LONG_LTE(exp, res)                                               \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_long(__CLOVE_ASSERT_LTE, exp, res, \
                                                 _this);                       \
    } while (0)
...
#define CLOVE_ULONG_EQ(exp, res)                                               \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_ulong(__CLOVE_ASSERT_EQ, exp, res, \
                                                  _this);                      \
    } while (0)
#define CLOVE_ULONG_NE(exp, res)                                               \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_ulong(__CLOVE_ASSERT_NE, exp, res, \
                                                  _this);                      \
    } while (0)
#define CLOVE_ULONG_GT(exp, res)                                               \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_ulong(__CLOVE_ASSERT_GT, exp, res, \
                                                  _this);                      \
    } while (0)
#define CLOVE_ULONG_GTE(exp, res)                                              \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_ulong(__CLOVE_ASSERT_GTE, exp,     \
                                                  res, _this);                 \
    } while (0)
#define CLOVE_ULONG_LT(exp, res)                                               \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_ulong(__CLOVE_ASSERT_LT, exp, res, \
                                                  _this);                      \
    } while (0)
#define CLOVE_ULONG_LTE(exp, res)                                              \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_ulong(__CLOVE_ASSERT_LTE, exp,     \
                                                  res, _this);                 \
    } while (0)
...
#define CLOVE_LLONG_EQ(exp, res)                                               \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_llong(__CLOVE_ASSERT_EQ, exp, res, \
                                                  _this);                      \
    } while (0)
#define CLOVE_LLONG_NE(exp, res)                                               \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_llong(__CLOVE_ASSERT_NE, exp, res, \
                                                  _this);                      \
    } while (0)
#define CLOVE_LLONG_GT(exp, res)                                               \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_llong(__CLOVE_ASSERT_GT, exp, res, \
                                                  _this);                      \
    } while (0)
#define CLOVE_LLONG_GTE(exp, res)                                              \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_llong(__CLOVE_ASSERT_GTE, exp,     \
                                                  res, _this);                 \
    } while (0)
#define CLOVE_LLONG_LT(exp, res)                                               \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_llong(__CLOVE_ASSERT_LT, exp, res, \
                                                  _this);                      \
    } while (0)
#define CLOVE_LLONG_LTE(exp, res)                                              \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_llong(__CLOVE_ASSERT_LTE, exp,     \
                                                  res, _this);                 \
    } while (0)
...
#define CLOVE_ULLONG_EQ(exp, res)                                              \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_ullong(__CLOVE_ASSERT_EQ, exp,     \
                                                   res, _this);                \
    } while (0)
#define CLOVE_ULLONG_NE(exp, res)                                              \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_ullong(__CLOVE_ASSERT_NE, exp,     \
                                                   res, _this);                \
    } while (0)
#define CLOVE_ULLONG_GT(exp, res)                                              \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_ullong(__CLOVE_ASSERT_GT, exp,     \
                                                   res, _this);                \
    } while (0)
#define CLOVE_ULLONG_GTE(exp, res)                                             \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_ullong(__CLOVE_ASSERT_GTE, exp,    \
                                                   res, _this);                \
    } while (0)
#define CLOVE_ULLONG_LT(exp, res)                                              \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_ullong(__CLOVE_ASSERT_LT, exp,     \
                                                   res, _this);                \
    } while (0)
#define CLOVE_ULLONG_LTE(exp, res)                                             \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_ullong(__CLOVE_ASSERT_LTE, exp,    \
                                                   res, _this);                \
    } while (0)

#define CLOVE_SIZET_EQ(exp, res)                                               \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_sizet(__CLOVE_ASSERT_EQ, exp, res, \
                                                  _this);                      \
    } while (0)
#define CLOVE_SIZET_NE(exp, res)                                               \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_sizet(__CLOVE_ASSERT_NE, exp, res, \
                                                  _this);                      \
    } while (0)
#define CLOVE_SIZET_GT(exp, res)                                               \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_sizet(__CLOVE_ASSERT_GT, exp, res, \
                                                  _this);                      \
    } while (0)
#define CLOVE_SIZET_GTE(exp, res)                                              \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_sizet(__CLOVE_ASSERT_GTE, exp,     \
                                                  res, _this);                 \
    } while (0)
#define CLOVE_SIZET_LT(exp, res)                                               \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_sizet(__CLOVE_ASSERT_LT, exp, res, \
                                                  _this);                      \
    } while (0)
#define CLOVE_SIZET_LTE(exp, res)                                              \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_sizet(__CLOVE_ASSERT_LTE, exp,     \
                                                  res, _this);                 \
    } while (0)
...
#define CLOVE_FLOAT_EQ_P(exp, res, prec)                                       \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_float(__CLOVE_ASSERT_EQ, exp, res, \
                                                  (unsigned char)prec, _this); \
    } while (0)
#define CLOVE_FLOAT_NE_P(exp, res, prec)                                       \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_float(__CLOVE_ASSERT_NE, exp, res, \
                                                  (unsigned char)prec, _this); \
    } while (0)
#define CLOVE_FLOAT_GT(exp, res)                                               \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_float(__CLOVE_ASSERT_GT, exp, res, \
                                                  (unsigned char)6, _this);    \
    } while (0)
#define CLOVE_FLOAT_GTE(exp, res)                                              \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_float(                             \
          __CLOVE_ASSERT_GTE, exp, res, (unsigned char)6, _this);              \
    } while (0)
#define CLOVE_FLOAT_LT(exp, res)                                               \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_float(__CLOVE_ASSERT_LT, exp, res, \
                                                  (unsigned char)6, _this);    \
    } while (0)
#define CLOVE_FLOAT_LTE(exp, res)                                              \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_float(                             \
          __CLOVE_ASSERT_LTE, exp, res, (unsigned char)6, _this);              \
    } while (0)
...
#define CLOVE_DOUBLE_EQ_P(exp, res, prec)                                      \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_double(__CLOVE_ASSERT_EQ, exp,     \
                                                   res, prec, _this);          \
    } while (0)
#define CLOVE_DOUBLE_NE_P(exp, res, prec)                                      \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_double(__CLOVE_ASSERT_NE, exp,     \
                                                   res, prec, _this);          \
    } while (0)
#define CLOVE_DOUBLE_GT(exp, res)                                              \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_double(                            \
          __CLOVE_ASSERT_GT, exp, res, (unsigned char)15, _this);              \
    } while (0)
#define CLOVE_DOUBLE_GTE(exp, res)                                             \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_double(                            \
          __CLOVE_ASSERT_GTE, exp, res, (unsigned char)15, _this);             \
    } while (0)
#define CLOVE_DOUBLE_LT(exp, res)                                              \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_double(                            \
          __CLOVE_ASSERT_LT, exp, res, (unsigned char)15, _this);              \
    } while (0)
#define CLOVE_DOUBLE_LTE(exp, res)                                             \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_double(                            \
          __CLOVE_ASSERT_LTE, exp, res, (unsigned char)15, _this);             \
    } while (0)

#define CLOVE_NULL(res)                                                        \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_null(__CLOVE_ASSERT_EQ, NULL,      \
                                                 (void*)res, _this);           \
    } while (0)
#define CLOVE_NOT_NULL(res)                                                    \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_null(__CLOVE_ASSERT_NE, NULL,      \
                                                 (void*)res, _this);           \
    } while (0)
...
#define CLOVE_PTR_EQ(p1, p2)                                                   \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_ptr(__CLOVE_ASSERT_EQ, (void*)p1,  \
                                                (void*)p2, _this);             \
    } while (0)
#define CLOVE_PTR_NE(p1, p2)                                                   \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_ptr(__CLOVE_ASSERT_NE, (void*)p1,  \
                                                (void*)p2, _this);             \
    } while (0)
#define CLOVE_PTR_GT(p1, p2)                                                   \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_ptr(__CLOVE_ASSERT_GT, (void*)p1,  \
                                                (void*)p2, _this);             \
    } while (0)
#define CLOVE_PTR_GTE(p1, p2)                                                  \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_ptr(__CLOVE_ASSERT_GTE, (void*)p1, \
                                                (void*)p2, _this);             \
    } while (0)
#define CLOVE_PTR_LT(p1, p2)                                                   \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_ptr(__CLOVE_ASSERT_LT, (void*)p1,  \
                                                (void*)p2, _this);             \
    } while (0)
#define CLOVE_PTR_LTE(p1, p2)                                                  \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_ptr(__CLOVE_ASSERT_LTE, (void*)p1, \
                                                (void*)p2, _this);             \
    } while (0)
...
#define CLOVE_STRING_EQ(exp, res)                                              \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_string(__CLOVE_ASSERT_EQ, exp,     \
                                                   res, _this);                \
    } while (0)
#define CLOVE_STRING_NE(exp, res)                                              \
    do                                                                         \
    {                                                                          \
        __CLOVE_ASSERT_GUARD __clove_assert_string(__CLOVE_ASSERT_NE, exp,     \
                                                   res, _this);                \
    } while (0)
